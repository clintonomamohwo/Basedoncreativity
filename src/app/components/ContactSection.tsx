...
export function ContactSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #1A1F4B 0%, #2A2F5B 100%)",
      }}
    >
      {/* Background Pattern */}
      <div
          ...
          >
            ...
            >
              ...
              <span
                style={{
                  background:
                    "linear-gradient(90deg, #FFC857 0%, #FFD88A 100%)",
            ...
            >
              Ready to elevate your brand? Let's start a
              conversation about bringing your vision to life
              with creativity that makes an impact.
            </p>
            ...
            {[
              {
                icon: Mail,
                label: "Email",
                value: "contact@bochq.com",
              },
              {
                icon: Phone,
                label: "Phone",
                value: "+1 (647) 847-9084",
              },
              {
                icon: MapPin,
                label: "Location",

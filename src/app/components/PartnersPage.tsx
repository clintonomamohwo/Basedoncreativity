...
export function PartnersPage() {
  return (
    <>
      <SEO title="Partners | Based on Creativity" description="The Based on Creativity partners page is in development and will soon highlight creative collaborations and strategic partnerships." path="/partners" robots="noindex, follow" />
      <ComingSoonPage
      title="Partners"

...
function mapSanityStoryToBook(
  story: SanityStory,
  index: number,
): LibraryBook {
  const palette =
    CMS_BOOK_PALETTES[index % CMS_BOOK_PALETTES.length];
  const firstParagraph =
    portableTextToParagraphs(story.body).at(0) || "";
  const subtitle = truncateSubtitle(
    story.excerpt ||
      firstParagraph ||
      "A new story from Based on Creativity.",
  );
...
const PRESS_PILLARS = [
  ...
  },
  {
    ...
    description:
      "Curated collections built around a theme, a mood, or a moment. Each anthology is a world unto itself.",
  },
  {
    label: "Original Fiction",
    description:
      "Short stories, novelettes, and narrative prose developed and published directly through the press.",
  },
  {
    label: "Visual Essays",
    description:
...
export function StoriesPage() {
  ...
  return (
    <>
      <SEO
        title="Stories | Based on Creativity"
        description="Browse the Based on Creativity stories collection, featuring original short fiction, poetic narratives, and immersive visual storytelling."
        path="/stories"
      />
      <div
        ref={containerRef}
      ...
      >
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, #1A1F4B 0%, #0f1228 50%, #0A1020 100%)",
            }}
          />
          <div
            className="absolute inset-0"
            style={{
              background:
                "radial-gradient(ellipse 60% 40% at 50% -5%, rgba(255,200,87,0.09), transparent)",
            }}
          />
          <StarField count={80} />
          <GrainOverlay />
        ...
        <motion.div
          style={{
            ...
            borderRadius: "9999px",
            background:
              "radial-gradient(circle, rgba(255,200,87,0.11) 0%, transparent 70%)",
            filter: "blur(80px)",
            pointerEvents: "none",
            zIndex: 1,
          }}
        ...
        <motion.div
          style={{
            ...
            borderRadius: "9999px",
            background:
              "radial-gradient(circle, rgba(246,230,180,0.09) 0%, transparent 70%)",
            filter: "blur(90px)",
            pointerEvents: "none",
            zIndex: 1,
          }}
        ...
        <div className="relative" style={{ zIndex: 2 }}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  anthologies, and visual essays: work built to
                  be held, read slowly, and remembered.
                </p>
                <p
                  style={{
                    fontFamily: "'Cormorant Garamond', serif",
                    fontStyle: "italic",
                    fontSize:
                      "clamp(1.0625rem, 2.5vw, 1.25rem)",
                    color: "rgba(255,200,87,0.6)",
                    lineHeight: 1.6,
                    margin: 0,
                  }}
                >
                  We are selective. We are slow on purpose. The
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(180deg, #0F1228 0%, transparent 30%, transparent 70%, #0F1228 100%)",
              }}
            />
            {/* Centred ornament */}
            <div
          ...
          <section
            style={{
              ...
              margin: "0 auto",
              padding:
                "clamp(72px, 10vw, 112px) clamp(20px, 5vw, 48px) clamp(80px, 11vw, 128px)",
            }}
          >
            {/* Section header */}
            <motion.div
            ...
            >
              ...
              >
                The growing catalogue of stories, fragments, and
                reflections from Creativity Base Press.
              </p>
            ...
            >
              ...
              >
                ...
                >
                  Creativity Base Press accepts a small number
                  of submissions and publishing partnerships
                  each year.
                </p>
                <button

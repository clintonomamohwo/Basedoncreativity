...
function GoldRule({ gradient = true }: { gradient?: boolean }) {
  return (
    <div
      style={{
        height: '1px',
...
function AbstractFrame({ accent = GOLD, style = {} }: { accent?: string; style?: React.CSSProperties }) {
  return (
    <div
      style={{
        width: '100%',
...
function CreationCard({ card, delay }: { card: CreationCard; delay: number }) {
  return (
    <motion.article
...
function InDevelopmentBand({ navigate }: { navigate: ReturnType<typeof useNavigate> }) {
  return (
    <section
      style={{
        background: NAVY_ALT,
...
function BottomCTA({ navigate }: { navigate: ReturnType<typeof useNavigate> }) {
  return (
    <section
      style={{
        background: NAVY,

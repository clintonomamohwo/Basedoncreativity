...
import { Sun, Moon, MapPin, Building2, Layers, Globe, ArrowRight } from 'lucide-react';
...
function GoldRule({ className = '' }: { className?: string }) {
  return (
    <div
      ...
      style={{ background: 'linear-gradient(90deg, transparent, #FFC857 40%, #FFC857 60%, transparent)' }}
    />
  );
}
...
function HeroBlock({
  sunY, sunOpacity, moonY, moonOpacity,
}: {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center px-4 md:px-12 lg:px-20 pt-36 pb-24">
      ...
      <motion.div style={{ y: sunY, opacity: sunOpacity }} className="absolute top-28 right-8 md:right-20 pointer-events-none z-10">
        <Sun className="w-20 h-20 md:w-32 md:h-32 text-[#FFC857] opacity-30" strokeWidth={1} />
      </motion.div>
      <motion.div style={{ y: moonY, opacity: moonOpacity }} className="absolute bottom-12 left-6 md:left-16 pointer-events-none z-10">
        <Moon className="w-16 h-16 md:w-24 md:h-24 text-[#F6E6B4] opacity-25" strokeWidth={1} />
      </motion.div>
      ...
      <div className="relative z-20 max-w-4xl">
        ...
        <motion.p
          ...
          style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(1.25rem, 3.5vw, 1.75rem)' }}
        >
        ...
        <motion.p
          ...
          style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: 'clamp(1rem, 2.5vw, 1.125rem)', lineHeight: 1.65 }}
        >
          Based on Creativity is an independent creative company rooted in Ontario, Canada. We live in the quiet space between reflection and expression — where ideas are gathered in stillness, shaped with intention, and released into the world as stories, images, platforms, and experiences that resonate.
        </motion.p>
      </div>
    </section>
  );
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{ background: 'rgba(255,200,87,0.12)', border: '1px solid rgba(255,200,87,0.25)' }}
                >
                  <Icon size={18} style={{ color: '#FFC857' }} />
                </div>
                <p
                  className="text-[#FFC857]/60 uppercase tracking-[0.2em] mb-2"
                  style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '0.65rem' }}
                >
                  {item.label}
                </p>
                <p
                  className="text-white mb-1"
                  style={{ fontFamily: "'Space Mono', monospace", fontSize: '0.875rem', fontWeight: 700, lineHeight: 1.4 }}
                >
                  {item.value}
                </p>
                <p
                  className="text-[#D8D7DB]/60"
                  style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '0.8125rem' }}
                >
                  {item.note}
                </p>
              </motion.div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(1.125rem, 3vw, 1.375rem)' }}
          >
            At the heart of everything we do lives a quiet duality — inspired by the balance of the sun and the moon.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          >
            ...
            >
              Indigo Blue (#1A1F4B) — depth, stillness, and the space where listening begins. Ideas gather in silence before they are ready to emerge. Reflection is not inaction; it is the foundation of everything intentional.
            </p>
          </motion.div>
          ...
          >
            ...
            <p
              ...
              style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.125rem' }}
            >
              Gold (#FFC857) — warmth, creativity, and the courage to release. Expression is the moment an idea stops being private and becomes a shared experience — illuminating what reflection quietly prepared.
            </p>
          </motion.div>
        </div>
        ...
        >
          <p
            ...
            style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(1.25rem, 4vw, 1.75rem)', lineHeight: 1.55 }}
          >
            "Between reflection and expression lies the space where creativity truly lives — and that space is where Based on Creativity was built."
          </p>
        </motion.div>
      </div>
    </section>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '1.0625rem', lineHeight: 1.65 }}
          >
            Based on Creativity is the parent company behind three distinct creative entities, each with its own domain, discipline, and audience — united by a shared philosophy and a single creative vision.
          </p>
        </motion.div>
        ...
        <div className="space-y-5">
          {BRANDS.map((brand, i) => (
            <motion.div
              ...
              style={{ background: brand.cardBg, backdropFilter: 'blur(10px)', borderColor: brand.border }}
            >
              {/* Slug badge */}
              <div className="flex-shrink-0">
                ...
                >
                  <span
                    style={{ fontFamily: "'Space Mono', monospace", fontWeight: 700, fontSize: '0.875rem', color: brand.accent, letterSpacing: '0.08em' }}
                  >
                    {brand.slug}
                  </span>
                </div>
                <p
                  ...
                  style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '0.7rem', color: `${brand.accent}80`, letterSpacing: '0.15em', textTransform: 'uppercase' }}
                >
                  {brand.domain}
                </p>
              </div>
              ...
              <div>
                <h3
                  className="mb-3"
                  style={{ fontFamily: "'Space Mono', monospace", fontWeight: 700, fontSize: 'clamp(1.125rem, 3vw, 1.375rem)', color: brand.accent }}
                >
                  {brand.name}
                </h3>
                <p
                  className="leading-relaxed"
                  style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '1rem', color: 'rgba(255,255,255,0.72)', lineHeight: 1.65 }}
                >
                  {brand.description}
                </p>
              </div>
        ...
        >
          <p
            ...
            style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '0.9375rem', lineHeight: 1.65 }}
          >
            <span style={{ color: '#FFC857', fontFamily: "'Space Mono', monospace", fontWeight: 700, fontSize: '0.875rem' }}>BOC Direct — </span>
            Graphic design, web development, merchandise, and brand identity services are delivered directly under the Based on Creativity banner, working alongside clients without intermediary structure.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            <div className="text-center md:text-left">
              <p
                className="text-white"
                style={{ fontFamily: "'Space Mono', monospace", fontWeight: 700, fontSize: '1rem' }}
              >
                Founder &amp; Creative Director
              </p>
              <p
                className="text-[#FFC857]/60 uppercase tracking-[0.2em] mt-1"
                style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '0.7rem' }}
              >
                Based on Creativity
              </p>
            </div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-5">
              {[
                { label: 'Creative vision', body: 'BOC exists to prove that independent creative companies can produce work that competes with — and often surpasses — the output of larger institutions.' },
                { label: 'On collaboration', body: 'Every project is a relationship. We take our time choosing the work we do and the people we do it with — because that care shows up on the page, the screen, and the platform.' },
              ].map((item) => (
                <div key={item.label} className="border-l-2 border-[#FFC857]/40 pl-5">
                  <p
                    className="text-[#FFC857] uppercase tracking-[0.15em] mb-1"
                    style={{ fontFamily: "'Space Mono', monospace", fontSize: '0.7rem', fontWeight: 700 }}
                  >
                    {item.label}
                  </p>
                  <p
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '1.0625rem', lineHeight: 1.65 }}
          >
            BOC collaborates with clients across Canada and internationally — in animation, editorial, graphic design, web development, merchandise, and digital platform work. Here is how we approach that work.
          </p>
        </motion.div>
          ...
          {PRINCIPLES.map((p, i) => (
            ...
            >
              <p
                ...
                style={{ fontFamily: "'Space Mono', monospace", fontWeight: 700, fontSize: '1.5rem' }}
              >
                {p.number}
              </p>
              <h3
                className="text-white mb-3"
                style={{ fontFamily: "'Space Mono', monospace", fontWeight: 700, fontSize: '1rem', letterSpacing: '0.01em' }}
              >
                {p.title}
              </h3>
              <p
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <blockquote
            ...
            style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(1.375rem, 5vw, 2.25rem)', lineHeight: 1.5 }}
          >
        ...
        >
          <button
            ...
            onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.background = '#FFC857'; }}
          >
            View Our Services
            <ArrowRight size={16} />
          </button>
...
export function AboutPage() {
  ...
  return (
    <div className="relative min-h-screen" style={{ background: '#1A1F4B' }}>
      {/* Background layers */}
      ...
      <div className="relative" style={{ zIndex: 1 }}>
        <HeroBlock sunY={sunY} sunOpacity={sunOpacity} moonY={moonY} moonOpacity={moonOpacity} />
        <AtAGlance />
        <Philosophy />
        <FamilyOfBrands />
        <LeadershipBlock />

...
import { Film, PenTool, Code2, BookOpen, ShoppingBag, Globe } from 'lucide-react';
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
            ...
            <div>
              ...
              >
                Six creative disciplines, one shared mission — to build work that
                endures across animation, design, development, publishing, merchandise,
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  borderRadius: '12px',
                  padding: '24px',
                  boxShadow: '0 2px 16px rgba(26, 31, 75, 0.07)',

      ...
      <div className="relative z-20 max-w-[1200px] mx-auto px-6 pt-28 pb-12 md:pt-36 md:pb-16">
        ...
        >
          <p
            ...
            style={{ fontFamily: "'Source Sans 3', sans-serif", color: 'rgba(255,200,87,0.6)' }}
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10 xl:gap-16 items-start">
          ...
          >
            <div
              style={{
                ...
                boxShadow: '0 24px 80px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,200,87,0.08)',
                position: 'relative',
                overflow: 'hidden',
              }}
            >
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    >
                      <CheckCircle
                        size={64}
                        style={{ color: '#FFC857', filter: 'drop-shadow(0 0 20px rgba(255,200,87,0.5))' }}
                      />
                    </motion.div>
                    <div>
                      <h2
                      ...
                      >
                        ...
                        to explore what we can create together.
                      </p>
                    </div>
                    <motion.button
                      onClick={() => { setSubmitted(false); setForm({ name: '', email: '', company: '', projectType: '', budget: '', message: '' }); }}
                      whileHover={{ scale: 1.04, boxShadow: '0 0 30px rgba(255,200,87,0.3)' }}
                      whileTap={{ scale: 0.97 }}
                      style={{
                        marginTop: '8px',
                        padding: '12px 28px',
                  ...
                  >
                          ...
                          <motion.button
                            ...
                            style={{
                              ...
                              background: form.projectType === pt
                                ...
                                : 'transparent',
                              color: form.projectType === pt ? '#FFC857' : 'rgba(255,255,255,0.5)',
                              fontFamily: "'Source Sans 3', sans-serif",
                              fontSize: '0.8125rem',
                              cursor: 'pointer',
                              transition: 'all 0.2s ease',
                              boxShadow: form.projectType === pt
                          ...
                          <motion.button
                            ...
                            style={{
                              ...
                              background: form.budget === b
                                ? 'rgba(255,200,87,0.14)'
                                : 'transparent',
                              color: form.budget === b ? '#FFC857' : 'rgba(255,255,255,0.5)',
                              fontFamily: "'Source Sans 3', sans-serif",
                              fontSize: '0.8125rem',
                              cursor: 'pointer',
                              transition: 'all 0.2s ease',
                              boxShadow: form.budget === b
                                ? '0 0 12px rgba(255,200,87,0.18)'
                                : 'none',
                            }}
                          >
                    ...
                    <motion.button
                      ...
                      whileHover={!submitting ? {
                        scale: 1.02,
                        boxShadow: '0 0 40px rgba(255,200,87,0.45), 0 8px 32px rgba(0,0,0,0.4)',
                      } : {}}
                      ...
                      style={{
                        ...
                        gap: '10px',
                        boxShadow: '0 4px 24px rgba(255,200,87,0.3)',
          ...
          >
            ...
            <div
              style={{
                background: 'linear-gradient(135deg, rgba(255,200,87,0.12) 0%, rgba(255,200,87,0.04) 100%)',
              ...
              <div className="flex flex-col gap-4">
                {contactInfo.map(({ icon: Icon, label, value, href }) => (
                  <div key={label} className="flex items-start gap-3">
                    ...
                    >
                      <Icon size={15} style={{ color: '#FFC857' }} />
                    </div>
                    <div>
                      <p
                        style={{

...
import {
  ...
  useToast,
  yt
} from "./chunk-Q2GYCGF4.js";
import {
  require_compiler_runtime
} from "./chunk-RWFCF33W.js";
import {
  BehaviorSubject,
  ChannelError,
  ClientError,
...
// node_modules/.pnpm/sanity@5.21.0_@emotion+is-prop-valid@1.4.0_@noble+hashes@2.2.0_@oclif+core@4.10.5_@sani_8aa0c393a3d566e9fa0fb36e1d6c3ba4/node_modules/sanity/lib/_chunks-es/StructureToolProvider.js
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources7-QWCD5CMU.js")
});
...
function getOrCreateChildNode(nodes, fieldName, reference) {
  ...
  if (node)
    return node.reference || (node.reference = reference), node;
  const createdNode = {
    reference,
...
function getExtendedProjection(schemaType, orderBy, strict = false, orderingName) {
...
function getOrderingMenuItemsForSchemaType(context, typeName) {
  ...
  return !type || !("orderings" in type) ? [] : (type.orderings ? type.orderings.concat(DEFAULT_ORDERING_OPTIONS) : DEFAULT_ORDERING_OPTIONS).map((ordering) => getOrderingMenuItem(context, ordering, getExtendedProjection(type, ordering.by, false, ordering.title)));
}
...
// node_modules/.pnpm/sanity@5.21.0_@emotion+is-prop-valid@1.4.0_@noble+hashes@2.2.0_@oclif+core@4.10.5_@sani_8aa0c393a3d566e9fa0fb36e1d6c3ba4/node_modules/sanity/lib/_chunks-es/structureTool.js
...
function useDiffViewState(t0) {
  ...
  const mode = t2, anyParamSet = [previousDocument, nextDocument, mode].some(_temp$L), previousState = (0, import_react2.useRef)(void 0), t3 = previousDocument ?? "", t4 = nextDocument ?? "", t5 = mode ?? "";
  let t6;
  ...
  let t8;
  $[15] !== anyParamSet || $[16] !== onParamsError || $[17] !== params ? (t8 = [anyParamSet, onParamsError, params], $[15] = anyParamSet, $[16] = onParamsError, $[17] = params, $[18] = t8) : t8 = $[18], (0, import_react2.useEffect)(t7, t8);
  let t9;
  bb0: {
    if (params.result === "error") {
      let t103;
      $[19] === Symbol.for("react.memo_cache_sentinel") ? (t103 = {
        isActive: false
  ...
  $[22] !== onActiveChanged || $[23] !== state2 ? (t10 = () => {
    var _a;
    typeof onActiveChanged == "function" && ((_a = previousState.current) == null ? void 0 : _a.isActive) !== state2.isActive && onActiveChanged(previousState.current, state2);
  }, t11 = [onActiveChanged, state2], $[22] = onActiveChanged, $[23] = state2, $[24] = t10, $[25] = t11) : (t10 = $[24], t11 = $[25]), (0, import_react2.useEffect)(t10, t11);
  let t12, t13;
  $[26] !== onTargetDocumentsChanged || $[27] !== state2 ? (t12 = () => {
    var _a, _b, _c, _d, _e, _f, _g;
    typeof onTargetDocumentsChanged == "function" && ((_a = previousState.current) == null ? void 0 : _a.isActive) && state2.isActive && !isEqual_default([(_c = (_b = previousState == null ? void 0 : previousState.current) == null ? void 0 : _b.documents) == null ? void 0 : _c.previous.id, (_e = (_d = previousState == null ? void 0 : previousState.current) == null ? void 0 : _d.documents) == null ? void 0 : _e.next.id], [(_f = state2.documents) == null ? void 0 : _f.previous.id, (_g = state2.documents) == null ? void 0 : _g.next.id]) && onTargetDocumentsChanged(previousState.current, state2);
  }, t13 = [onTargetDocumentsChanged, state2], $[26] = onTargetDocumentsChanged, $[27] = state2, $[28] = t12, $[29] = t13) : (t12 = $[28], t13 = $[29]), (0, import_react2.useEffect)(t12, t13);
  let t14, t15;
  return $[30] !== state2 ? (t14 = () => {
    previousState.current = state2;
  }, t15 = [state2], $[30] = state2, $[31] = t14, $[32] = t15) : (t14 = $[31], t15 = $[32]), (0, import_react2.useEffect)(t14, t15), state2;
}
...
function selectActiveTransition(previousState, state2) {
  if (!(previousState == null ? void 0 : previousState.isActive) && state2.isActive)
    return "entered";
  if ((previousState == null ? void 0 : previousState.isActive) && !state2.isActive)
    return "exited";
}
...
var VersionModeHeaderLayout = yt.header.withConfig({
...
var VersionModeHeaderLayoutSection = yt.div.withConfig({
...
var VersionModeHeader = (t0) => {
  ...
  let t22;
  $[2] !== documentVersions ? (t22 = documentVersions.flatMap(_temp$J), $[2] = documentVersions, $[3] = t22) : t22 = $[3];
  ...
  let t11;
  $[31] === Symbol.for("react.memo_cache_sentinel") ? (t11 = (0, import_jsx_runtime2.jsx)(Flex, { align: "center", paddingX: 3, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(TransferIcon, {}) }) }), $[31] = t11) : t11 = $[31];
  let t12;
  $[32] !== documentId || $[33] !== documents || $[34] !== onSelectNextRelease || $[35] !== releases || $[36] !== releasesState || $[37] !== state2 ? (t12 = typeof (documents == null ? void 0 : documents.next) < "u" && (0, import_jsx_runtime2.jsx)(VersionMenu, { releases, releasesState, onSelectRelease: onSelectNextRelease, role: "next", documentId, state: state2, document: documents.next }), $[32] = documentId, $[33] = documents, $[34] = onSelectNextRelease, $[35] = releases, $[36] = releasesState, $[37] = state2, $[38] = t12) : t12 = $[38];
  let t13;
  $[39] === Symbol.for("react.memo_cache_sentinel") ? (t13 = {
    justifySelf: "end"
  }, $[39] = t13) : t13 = $[39];
  let t14;
...
var VersionMenu = (t0) => {
  ...
  if ($[29] !== documentId || $[30] !== onSelectRelease || $[31] !== releases || $[32] !== selected) {
    let t122;
    $[34] !== documentId || $[35] !== onSelectRelease || $[36] !== selected ? (t122 = (release) => (0, import_jsx_runtime2.jsx)(VersionMenuItem, { release, onSelect: onSelectRelease, isSelected: typeof selected != "string" && (selected == null ? void 0 : selected._id) === release._id, documentId }, release._id), $[34] = documentId, $[35] = onSelectRelease, $[36] = selected, $[37] = t122) : t122 = $[37], t11 = releases.map(t122), $[29] = documentId, $[30] = onSelectRelease, $[31] = releases, $[32] = selected, $[33] = t11;
  } else
    t11 = $[33];
  let t12;
...
var VersionMenuItem = (t0) => {
  ...
  if (type) {
    ...
    let t22;
    $[5] !== releasePerspective ? (t22 = (0, import_jsx_runtime2.jsx)(ReleaseAvatar, { padding: 2, release: releasePerspective }), $[5] = releasePerspective, $[6] = t22) : t22 = $[6];
    let t32;
  ...
  let t2;
  $[21] !== release ? (t2 = (0, import_jsx_runtime2.jsx)(ReleaseAvatar, { padding: 2, release }), $[21] = release, $[22] = t2) : t2 = $[22];
  let t3;
  $[23] === Symbol.for("react.memo_cache_sentinel") ? (t3 = {
    minWidth: 0
  }, $[23] = t3) : t3 = $[23];
  ...
  let t7;
  $[27] !== release.metadata.title || $[28] !== t5 ? (t7 = (0, import_jsx_runtime2.jsx)(ReleaseTitle, { title: t4, fallback: t5, textProps: t6 }), $[27] = release.metadata.title, $[28] = t5, $[29] = t7) : t7 = $[29];
  let t8;
  $[30] !== release.metadata.releaseType || $[31] !== tCore ? (t8 = ["asap", "undecided"].includes(release.metadata.releaseType) && (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: tCore(`release.type.${release.metadata.releaseType}`) }), $[30] = release.metadata.releaseType, $[31] = tCore, $[32] = t8) : t8 = $[32];
  let t9;
  $[33] !== release ? (t9 = release.metadata.releaseType === "scheduled" && (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: formatRelativeLocalePublishDate(release) }), $[33] = release, $[34] = t9) : t9 = $[34];
  let t10;
  $[35] !== t7 || $[36] !== t8 || $[37] !== t9 ? (t10 = (0, import_jsx_runtime2.jsxs)(Stack, { flex: 1, paddingY: 2, paddingRight: 2, space: 2, style: t3, children: [
    t7,
    t8,
    t9
  ] }), $[35] = t7, $[36] = t8, $[37] = t9, $[38] = t10) : t10 = $[38];
  let t11;
  $[39] !== release ? (t11 = isReleaseScheduledOrScheduling(release) && (0, import_jsx_runtime2.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(LockIcon, {}) }) }), $[39] = release, $[40] = t11) : t11 = $[40];
  let t12;
  $[41] !== t11 ? (t12 = (0, import_jsx_runtime2.jsx)(Flex, { flex: "none", children: t11 }), $[41] = t11, $[42] = t12) : t12 = $[42];
  let t13;
  $[43] !== t10 || $[44] !== t12 || $[45] !== t2 ? (t13 = (0, import_jsx_runtime2.jsxs)(Flex, { gap: 1, children: [
    t2,
    t10,
    t12
  ] }), $[43] = t10, $[44] = t12, $[45] = t2, $[46] = t13) : t13 = $[46];
  let t14;
  return $[47] !== isSelected || $[48] !== onClick || $[49] !== t13 ? (t14 = (0, import_jsx_runtime2.jsx)(MenuItem, { padding: 1, paddingRight: 3, onClick, pressed: isSelected, children: t13 }), $[47] = isSelected, $[48] = onClick, $[49] = t13, $[50] = t14) : t14 = $[50], t14;
};
function getMenuButtonProps({
  ...
  if (isReleaseDocument(selected)) {
    ...
    return {
      ...
      icon: (0, import_jsx_runtime2.jsx)(ReleaseAvatar, { padding: 1, release: selected }),
  ...
  if (isSystemBundleName(selected)) {
    ...
    return {
      ...
      icon: (0, import_jsx_runtime2.jsx)(ReleaseAvatar, { padding: 1, release: releasePerspective }),
      tone
    };
  }
  return {
    ...
    icon: (0, import_jsx_runtime2.jsx)(ReleaseAvatar, { padding: 1, releaseType: "undecided" }),
    tone: "neutral"
  };
}
...
var DialogLayout = yt.div.withConfig({
...
var Scroller$5 = yt.div.withConfig({
...
var DiffViewDocument = (t0) => {
  ...
  const compareValue = useCompareValue(t1), {
    data: releases
  } = useActiveReleases(), [patchChannel] = (0, import_react2.useState)(_temp$H);
  let t2;
...
var DiffViewDocumentLayout = (t0) => {
  ...
  let t22, t3;
  $[3] !== log ? (t22 = (previousState, state2) => {
    var _a, _b, _c, _d;
    if (selectActiveTransition(previousState, state2) === "entered") {
      log(DiffViewEntered, {
        documentVariantTypes: documentIdsToVariantTypes([(_a = state2.documents) == null ? void 0 : _a.previous.id, (_b = state2.documents) == null ? void 0 : _b.next.id])
      });
      return;
    }
    selectActiveTransition(previousState, state2) === "exited" && typeof previousState < "u" && log(DiffViewExited, {
      documentVariantTypes: documentIdsToVariantTypes([(_c = previousState.documents) == null ? void 0 : _c.previous.id, (_d = previousState.documents) == null ? void 0 : _d.next.id])
    });
  }, t3 = (previousState_0, state_0) => {
    var _a, _b, _c, _d;
    typeof previousState_0 > "u" || log(DiffViewDocumentSelectionChanged, {
      previousDocumentVariantTypes: documentIdsToVariantTypes([(_a = previousState_0.documents) == null ? void 0 : _a.previous.id, (_b = previousState_0.documents) == null ? void 0 : _b.next.id]),
      documentVariantTypes: documentIdsToVariantTypes([(_c = state_0.documents) == null ? void 0 : _c.previous.id, (_d = state_0.documents) == null ? void 0 : _d.next.id])
    });
  }, $[3] = log, $[4] = t22, $[5] = t3) : (t22 = $[4], t3 = $[5]);
  let t4;
  $[6] !== t1 || $[7] !== t22 || $[8] !== t3 ? (t4 = {
    onParamsError: t1,
    onActiveChanged: t22,
    onTargetDocumentsChanged: t3
  }, $[6] = t1, $[7] = t22, $[8] = t3, $[9] = t4) : t4 = $[9];
  const {
    isActive
  } = useDiffViewState(t4);
  let t5;
  $[10] !== documentId || $[11] !== isActive ? (t5 = isActive && (0, import_jsx_runtime2.jsx)(DiffView, { documentId }), $[10] = documentId, $[11] = isActive, $[12] = t5) : t5 = $[12];
  let t6;
  return $[13] !== children || $[14] !== t5 ? (t6 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    children,
    t5
...
var Root$a = yt(Layer).withConfig({
  displayName: "Root",
...
var Pane = (0, import_react2.forwardRef)(function(props, forwardedRef) {
  ...
  if ($[10] !== panes || $[11] !== rootElement) {
    ...
    pane = $[12], t2 = $[13];
  const paneIndex = t2, nextPane = typeof paneIndex == "number" ? panes[paneIndex + 1] : void 0, isLast = paneIndex === panes.length - 1, expanded = expandedElement === rootElement, collapsed = layoutCollapsed ? false : (pane == null ? void 0 : pane.collapsed) || false, nextCollapsed = (nextPane == null ? void 0 : nextPane.collapsed) || false, ref = (0, import_react2.useRef)(null), flex = (pane == null ? void 0 : pane.flex) ?? flexProp, currentMinWidth = (pane == null ? void 0 : pane.currentMinWidth) ?? currentMinWidthProp, currentMaxWidth = (pane == null ? void 0 : pane.currentMaxWidth) ?? currentMaxWidthProp;
  let t3;
...
var Root$7 = yt(Layer).withConfig({
  displayName: "Root",
  componentId: "sc-rwc61s-0"
})`position:sticky;bottom:0;`;
var RootCard = yt(Card).withConfig({
...
var Root$6 = yt(Layer).withConfig({
  displayName: "Root",
...
var TitleTextSkeleton = yt(TextSkeleton).withConfig({
  displayName: "TitleTextSkeleton",
  componentId: "sc-2mpzxb-3"
})`width:66%;max-width:175px;`;
var TitleText = yt(Text).withConfig({
...
var PaneHeader$1 = (0, import_react2.forwardRef)(function(props, ref) {
  ...
  } = usePane(), paneRect = useElementRect(paneElement || null), t0 = collapsed ? (paneRect == null ? void 0 : paneRect.height) || window.innerHeight : void 0;
  let t1;
  $[0] !== t0 ? (t1 = {
    width: t0
  }, $[0] = t0, $[1] = t1) : t1 = $[1];
...
function PaneLayout(props) {
  ...
  const [controller] = (0, import_react2.useState)(_temp$G), [rootElement, setRootElement] = (0, import_react2.useState)(null), width = ((_a = useElementRect(rootElement)) == null ? void 0 : _a.width) || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
var Content$2 = yt(Flex).withConfig({
  displayName: "Content",
...
function CommentsProviderWrapper(props) {
  const $ = (0, import_compiler_runtime2.c)(28), {
    ...
    resolveIntentLink
  } = useRouter(), selectedCommentId = params == null ? void 0 : params.comment, scheduledDraft = params == null ? void 0 : params.scheduledDraft, paramsRef = (0, import_react2.useRef)(params);
  let t0, t1;
  $[0] !== params ? (t0 = () => {
  ...
  let t4;
  $[11] !== (inspector == null ? void 0 : inspector.name) || $[12] !== openInspector ? (t4 = () => {
    (inspector == null ? void 0 : inspector.name) !== COMMENTS_INSPECTOR_NAME && openInspector(COMMENTS_INSPECTOR_NAME);
  }, $[11] = inspector == null ? void 0 : inspector.name, $[12] = openInspector, $[13] = t4) : t4 = $[13];
...
function DocumentActionsProvider(props) {
  ...
  let t0;
  if ($[0] !== activeReleases || $[1] !== (editState == null ? void 0 : editState.release)) {
    let t12;
    $[3] !== (editState == null ? void 0 : editState.release) ? (t12 = (candidate) => candidate === (editState == null ? void 0 : editState.release), $[3] = editState == null ? void 0 : editState.release, $[4] = t12) : t12 = $[4], t0 = activeReleases.map(_temp$F).find(t12), $[0] = activeReleases, $[1] = editState == null ? void 0 : editState.release, $[2] = t0;
  } else
    t0 = $[2];
  ...
  if (!actionProps)
    return null;
  let t2;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => {
    var _a;
    return (_a = onCompleteRef.current) == null ? void 0 : _a.call(onCompleteRef);
  }, $[10] = t2) : t2 = $[10];
  let t3;
  $[11] !== actionProps ? (t3 = {
    ...actionProps,
...
function useDocumentPaneInfo() {
  const documentPaneInfo = (0, import_react2.useContext)(DocumentPaneInfoContext);
  if (!documentPaneInfo)
...
function useDocumentTitle() {
  ...
  bb0: {
    ...
    if (selectedPerspectiveName && isPublishedPerspective(selectedPerspectiveName)) {
      t0 = editState == null ? void 0 : editState.published;
      break bb0;
    }
    t0 = (editState == null ? void 0 : editState.version) || (editState == null ? void 0 : editState.draft) || (editState == null ? void 0 : editState.published);
  }
  ...
  if (!value && !isDeleted) {
    const t42 = (schemaType == null ? void 0 : schemaType.title) || (schemaType == null ? void 0 : schemaType.name);
    let t52;
  ...
  const t4 = value == null ? void 0 : value.title;
  let t5;
  return $[20] !== t4 ? (t5 = {
    error: void 0,
    title: t4
...
var DocumentOperationResults = (0, import_react2.memo)(function() {
  const $ = (0, import_compiler_runtime2.c)(13), {
    ...
    documentId,
    documentType
  } = useDocumentPaneInfo(), documentTitleInfo = useDocumentTitle(), titleError = documentTitleInfo.error, event = useDocumentOperationEvent(documentId, documentType), prevEvent = (0, import_react2.useRef)(event), paneRouter = usePaneRouter(), {
    t: t2
  } = useTranslation(structureLocaleNamespace), {
    handleOpenDialog
  } = useDocumentLimitsUpsellContext();
  let t0;
  bb0: {
    if (!documentTitleInfo.title && !titleError && event && !IGNORE_OPS.includes(event.op) && typeof documentPaneValue.title == "string" && (event == null ? void 0 : event.type) === "success") {
  ...
  return $[5] !== documentTitle || $[6] !== event || $[7] !== handleOpenDialog || $[8] !== paneRouter || $[9] !== pushToast || $[10] !== t2 ? (t3 = () => {
    ...
    return event.type === "success" && !IGNORE_OPS.includes(event.op) && pushToast({
      closable: true,
      status: "success",
      title: (0, import_jsx_runtime2.jsx)(Translate, { context: event.op === "publish" && event.idPair.versionId ? "publishVersion" : event.op, i18nKey: "panes.document-operation-results.operation-success", t: t2, values: {
        op: event.op,
        title: documentTitle
      }, components: {
        Strong: "strong"
...
function DocumentInspectorPanel(props) {
  ...
  let t1;
  $[3] !== Component || $[4] !== documentId || $[5] !== documentType || $[6] !== handleClose ? (t1 = (0, import_jsx_runtime2.jsx)(DivergencesProvider, { enabled: false, children: (0, import_jsx_runtime2.jsx)(Component, { onClose: handleClose, documentId, documentType }) }), $[3] = Component, $[4] = documentId, $[5] = documentType, $[6] = handleClose, $[7] = t1) : t1 = $[7];
  const element = t1;
...
var JSONInspectorWrapper = yt.div.withConfig({
...
var DialogBody$1 = yt(Box).withConfig({
...
function RequestPermissionDialog(t0) {
  ...
  bb0: {
    ...
    if ($[2] !== client.observable || $[3] !== projectId) {
      let t42;
      $[5] === Symbol.for("react.memo_cache_sentinel") ? (t42 = (roles) => roles.filter(_temp$D).find(_temp2$h) ? "editor" : adminRole, $[5] = t42) : t42 = $[5];
      let t52;
...
function InsufficientPermissionBanner(t0) {
  ...
  const listFormat = useListFormat(t1), {
    t: t2
  } = useTranslation(structureLocaleNamespace), telemetry = useTelemetry(), roleTitles = currentUserRoles.map(_temp$C), roles = listFormat.formatToParts(roleTitles).map(_temp2$g);
  let t22;
  $[1] !== roles ? (t22 = {
...
var ReferenceChangedBanner = (0, import_react2.memo)(() => {
  ...
  const $ = (0, import_compiler_runtime2.c)(32), documentPreviewStore = useDocumentPreviewStore(), {
    ...
    replaceCurrent,
    BackLink: BackLink2
  } = usePaneRouter(), routerReferenceId = (_a = routerPanesState[groupIndex]) == null ? void 0 : _a[0].id, parentSibling = (_b = routerPanesState[groupIndex - 1]) == null ? void 0 : _b[0], parentId = parentSibling == null ? void 0 : parentSibling.id, hasHistoryOpen = !!((_c = parentSibling == null ? void 0 : parentSibling.params) == null ? void 0 : _c.rev);
  let t0;
  $[0] !== params ? (t0 = (params == null ? void 0 : params.parentRefPath) && fromString(params.parentRefPath) || null, $[0] = params, $[1] = t0) : t0 = $[1];
  ...
  let t22;
  $[13] === Symbol.for("react.memo_cache_sentinel") ? (t22 = {
    loading: true
  }, $[13] = t22) : t22 = $[13];
  ...
  if (!parentId || !parentRefPath || hasHistoryOpen || referenceInfo.loading || !((_d = referenceInfo.result) == null ? void 0 : _d.availability.draft.available) && !((_e = referenceInfo.result) == null ? void 0 : _e.availability.published.available) || ((_f = referenceInfo.result) == null ? void 0 : _f.refValue) === routerReferenceId)
    return null;
  let t4;
  $[19] !== BackLink2 || $[20] !== handleReloadReference || $[21] !== ((_g = referenceInfo.result) == null ? void 0 : _g.refValue) || $[22] !== t2 ? (t4 = ((_h = referenceInfo.result) == null ? void 0 : _h.refValue) ? {
  ...
  }, $[19] = BackLink2, $[20] = handleReloadReference, $[21] = (_i = referenceInfo.result) == null ? void 0 : _i.refValue, $[22] = t2, $[23] = t4) : t4 = $[23];
  let t5;
  $[24] !== ((_j = referenceInfo.result) == null ? void 0 : _j.refValue) || $[25] !== t2 ? (t5 = ((_k = referenceInfo.result) == null ? void 0 : _k.refValue) ? t2("banners.reference-changed-banner.reason-changed.text") : t2("banners.reference-changed-banner.reason-removed.text"), $[24] = (_l = referenceInfo.result) == null ? void 0 : _l.refValue, $[25] = t2, $[26] = t5) : t5 = $[26];
  let t6;
...
function ScheduledDraftOverrideBanner(t0) {
  ...
  } = useScheduledDraftDocument(releaseId), draftPublishedId = (draftDocument == null ? void 0 : draftDocument._id) ? getPublishedId(draftDocument._id) : null, scheduledPublishedId = (scheduledDraftDocument == null ? void 0 : scheduledDraftDocument._id) ? getPublishedId(scheduledDraftDocument._id) : null, draftRev = draftDocument == null ? void 0 : draftDocument._rev, scheduledBaseRev = (_b = (_a = scheduledDraftDocument == null ? void 0 : scheduledDraftDocument._system) == null ? void 0 : _a.base) == null ? void 0 : _b.rev;
...
function ArchivedReleaseDocumentBanner() {
  ...
  let t1;
  if ($[3] !== archivedReleases || $[4] !== (params == null ? void 0 : params.historyVersion)) {
    let t222;
    $[6] !== (params == null ? void 0 : params.historyVersion) ? (t222 = (r2) => getReleaseIdFromReleaseDocumentId(r2._id) === (params == null ? void 0 : params.historyVersion), $[6] = params == null ? void 0 : params.historyVersion, $[7] = t222) : t222 = $[7], t1 = archivedReleases.find(t222), $[3] = archivedReleases, $[4] = params == null ? void 0 : params.historyVersion, $[5] = t1;
  } else
    t1 = $[5];
  const release = t1;
  let t22;
  bb0: {
    if ((release == null ? void 0 : release.state) === "published") {
  ...
  const description = t22, t3 = release == null ? void 0 : release.metadata.title;
  let t4;
  ...
  let t7;
  $[18] !== handleGoBack || $[19] !== (params == null ? void 0 : params.archivedRelease) ? (t7 = (params == null ? void 0 : params.archivedRelease) ? void 0 : {
    text: "Go back to published version",
    onClick: handleGoBack
  }, $[18] = handleGoBack, $[19] = params == null ? void 0 : params.archivedRelease, $[20] = t7) : t7 = $[20];
  let t8;
  return $[21] !== t6 || $[22] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(Banner, { tone: "caution", content: t6, action: t7 }), $[21] = t6, $[22] = t7, $[23] = t8) : t8 = $[23], t8;
}
var Image = yt.img.withConfig({
  displayName: "Image",
...
var CanvasPopoverContent = (t0) => {
  ...
  let t4;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t4 = (0, import_jsx_runtime2.jsx)(Image, { src: CANVAS_IMAGE_URL, alt: "Canvas" }), $[7] = t4) : t4 = $[7];
  let t5;
  $[8] === Symbol.for("react.memo_cache_sentinel") ? (t5 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "semibold", children: CANVAS_APP_NAME }), $[8] = t5) : t5 = $[8];
  let t6;
  $[9] === Symbol.for("react.memo_cache_sentinel") ? (t6 = (0, import_jsx_runtime2.jsxs)(Flex, { paddingY: 1, gap: 2, children: [
    t5,
...
var CanvasLinkedBannerContent = (t0) => {
  ...
  let t22;
  $[8] === Symbol.for("react.memo_cache_sentinel") ? (t22 = () => setOpen(_temp$A), $[8] = t22) : t22 = $[8];
  const togglePopover = t22;
  let t3;
  $[9] === Symbol.for("react.memo_cache_sentinel") ? (t3 = () => setOpen(false), $[9] = t3) : t3 = $[9];
  const onClose = t3;
  let t4;
  ...
  let t6;
  $[14] === Symbol.for("react.memo_cache_sentinel") ? (t6 = (0, import_jsx_runtime2.jsx)(Button2, { tooltipProps: null, mode: "bleed", tone: "default", icon: InfoOutlineIcon, onClick: togglePopover }), $[14] = t6) : t6 = $[14];
  let t7;
...
function DocumentNotInReleaseBanner(t0) {
  ...
  let t32;
  $[2] !== currentRelease || $[3] !== isAnonymousBundle || $[4] !== tCore ? (t32 = isAnonymousBundle ? currentRelease : ((_a = currentRelease == null ? void 0 : currentRelease.metadata) == null ? void 0 : _a.title) || tCore("release.placeholder-untitled-release"), $[2] = currentRelease, $[3] = isAnonymousBundle, $[4] = tCore, $[5] = t32) : t32 = $[5];
  ...
  const handleAddToRelease = t4, now = useCurrentTime(200), t5 = (versionCreateState == null ? void 0 : versionCreateState.status) === "created" && now.getTime() - versionCreateState.lastUpdate.getTime() > TOAST_DELAY;
  let t6;
  ...
  $[23] !== currentRelease || $[24] !== isAnonymousBundle || $[25] !== tCore ? (t10 = {
    VersionBadge: (t112) => {
      ...
      return isAnonymousBundle ? (0, import_jsx_runtime2.jsx)(BadgeWithTone, { children }) : (0, import_jsx_runtime2.jsx)(ReleaseTitle, { title: (_a2 = currentRelease.metadata) == null ? void 0 : _a2.title, fallback: tCore("release.placeholder-untitled-release"), children: () => (0, import_jsx_runtime2.jsx)(BadgeWithTone, { children }) });
    }
  ...
  let t12;
  $[31] !== currentRelease || $[32] !== handleAddToRelease || $[33] !== isScheduledRelease || $[34] !== t3 || $[35] !== tone || $[36] !== versionCreateState ? (t12 = isScheduledRelease ? void 0 : {
    text: isAgentBundleName(currentRelease) ? t3("banners.release.action.add-to-bundle") : t3("banners.release.action.add-to-release"),
    tone,
    disabled: !!versionCreateState,
    onClick: handleAddToRelease,
    mode: "default"
  }, $[31] = currentRelease, $[32] = handleAddToRelease, $[33] = isScheduledRelease, $[34] = t3, $[35] = tone, $[36] = versionCreateState, $[37] = t12) : t12 = $[37];
  let t13;
  return $[38] !== t11 || $[39] !== t12 || $[40] !== tone ? (t13 = (0, import_jsx_runtime2.jsx)(Banner, { tone, content: t11, action: t12 }), $[38] = t11, $[39] = t12, $[40] = tone, $[41] = t13) : t13 = $[41], t13;
}
...
function UnpublishedDocumentBanner() {
  ...
  const $ = (0, import_compiler_runtime2.c)(17), {
    ...
    selectedPerspective
  } = usePerspective(), isCurrentVersionGoingToUnpublish = isGoingToUnpublish(value) || (editState == null ? void 0 : editState.version) && isGoingToUnpublish(editState == null ? void 0 : editState.version), {
    t: t2
  } = useTranslation(structureLocaleNamespace), {
    t: tCore
  } = useTranslation();
  if (isReleaseDocument(selectedPerspective) && isCurrentVersionGoingToUnpublish) {
    ...
    $[5] !== selectedPerspective || $[6] !== tCore ? (t22 = {
      VersionBadge: (t32) => {
        ...
        return (0, import_jsx_runtime2.jsx)(ReleaseTitle, { title: (_a2 = selectedPerspective.metadata) == null ? void 0 : _a2.title, fallback: tCore("release.placeholder-untitled-release"), children: () => (0, import_jsx_runtime2.jsx)(BadgeWithTone, { children }) });
      }
...
var TitleContainer = yt(Stack).withConfig({
...
var FormView = (0, import_react2.forwardRef)(function(props, ref) {
  var _a;
  const $ = (0, import_compiler_runtime2.c)(78), {
    hidden,
    margins
  } = props, {
    collapsedFieldSets,
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react2.useState)(_temp$z), isLocked = (_a = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a.enabled, {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0;
  ...
  let t8;
  $[28] !== focusedFirstDescendant || $[29] !== formRef || $[30] !== (formState == null ? void 0 : formState.focusPath.length) || $[31] !== ready ? (t8 = () => {
  ...
  }, $[28] = focusedFirstDescendant, $[29] = formRef, $[30] = formState == null ? void 0 : formState.focusPath.length, $[31] = ready, $[32] = t8) : t8 = $[32];
  const t9 = formState == null ? void 0 : formState.focusPath.length;
  let t10;
  ...
  const setRef = t11, isReadOnly = connectionState === "reconnecting" || (formState == null ? void 0 : formState.readOnly) || !(editState == null ? void 0 : editState.ready), t12 = isReadOnly ? "true" : void 0;
  let t13;
  $[40] !== collapsedFieldSets || $[41] !== collapsedPaths || $[42] !== compareValue || $[43] !== connectionState || $[44] !== documentId || $[45] !== (editState == null ? void 0 : editState.draft) || $[46] !== (editState == null ? void 0 : editState.published) || $[47] !== fieldActions || $[48] !== formState || $[49] !== hasUpstreamVersion || $[50] !== hidden || $[51] !== inspectOpen || $[52] !== isReadOnly || $[53] !== onBlur || $[54] !== onChange || $[55] !== onFocus || $[56] !== onPathOpen || $[57] !== onSetActiveFieldGroup || $[58] !== onSetCollapsedFieldSet || $[59] !== onSetCollapsedPath || $[60] !== openPath || $[61] !== patchChannel || $[62] !== presence || $[63] !== selectedPerspective || $[64] !== t2 || $[65] !== title || $[66] !== validation ? (t13 = connectionState === "connecting" && !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published) ? (0, import_jsx_runtime2.jsx)(Delay, { ms: 300, children: (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: [
    ...
    (0, import_jsx_runtime2.jsx)(FormRow, { children: (0, import_jsx_runtime2.jsx)(FormHeader, { documentId, schemaType: formState.schemaType, title }) }),
  ...
  ] }), $[40] = collapsedFieldSets, $[41] = collapsedPaths, $[42] = compareValue, $[43] = connectionState, $[44] = documentId, $[45] = editState == null ? void 0 : editState.draft, $[46] = editState == null ? void 0 : editState.published, $[47] = fieldActions, $[48] = formState, $[49] = hasUpstreamVersion, $[50] = hidden, $[51] = inspectOpen, $[52] = isReadOnly, $[53] = onBlur, $[54] = onChange, $[55] = onFocus, $[56] = onPathOpen, $[57] = onSetActiveFieldGroup, $[58] = onSetCollapsedFieldSet, $[59] = onSetCollapsedPath, $[60] = openPath, $[61] = patchChannel, $[62] = presence, $[63] = selectedPerspective, $[64] = t2, $[65] = title, $[66] = validation, $[67] = t13) : t13 = $[67];
  let t14;
  $[68] !== setRef || $[69] !== t12 || $[70] !== t13 ? (t14 = (0, import_jsx_runtime2.jsx)(Box, { as: "form", onSubmit: preventDefault, ref: setRef, "data-testid": "form-view", "data-read-only": t12, children: t13 }), $[68] = setRef, $[69] = t12, $[70] = t13, $[71] = t14) : t14 = $[71];
  let t15;
  $[72] !== margins || $[73] !== t14 ? (t15 = (0, import_jsx_runtime2.jsx)(PresenceOverlay, { margins, children: t14 }), $[72] = margins, $[73] = t14, $[74] = t15) : t15 = $[74];
  let t16;
  return $[75] !== hidden || $[76] !== t15 ? (t16 = (0, import_jsx_runtime2.jsx)(FormContainer, { hidden, children: t15 }), $[75] = hidden, $[76] = t15, $[77] = t16) : t16 = $[77], t16;
});
...
function DocumentHeaderBreadcrumbItem(t0) {
  ...
  let t1;
  $[0] !== (routerState == null ? void 0 : routerState.panes) ? (t1 = (routerState == null ? void 0 : routerState.panes) || [], $[0] = routerState == null ? void 0 : routerState.panes, $[1] = t1) : t1 = $[1];
  const routerPanes = t1, {
    perspectiveStack
  } = usePerspective(), staticTitle = pane !== LOADING_PANE && "title" in pane ? pane.title : null, documentId = pane !== LOADING_PANE && pane.type === "document" ? pane.options.id : null, documentType = pane !== LOADING_PANE && pane.type === "document" ? pane.options.type : null, t22 = documentId ?? "", t3 = documentType ?? "";
  let t4;
  ...
  bb0: {
    if (documentId && !isLoading) {
      let t62;
      $[6] !== (previewValue == null ? void 0 : previewValue.title) || $[7] !== t2 ? (t62 = (previewValue == null ? void 0 : previewValue.title) || t2("panes.document-header-title.untitled.text"), $[6] = previewValue == null ? void 0 : previewValue.title, $[7] = t2, $[8] = t62) : t62 = $[8], t5 = t62;
      break bb0;
    }
    t5 = staticTitle;
  }
  ...
  if ($[0] !== currentPaneIndex || $[1] !== paneDataItems) {
    ...
    $[3] !== currentPaneIndex ? (t22 = (paneData, idx) => {
      ...
      return (0, import_jsx_runtime2.jsxs)(import_react2.Fragment, { children: [
        ...
        idx < currentPaneIndex && (isDocumentPane2 ? (0, import_jsx_runtime2.jsx)(Box, { padding: 1, children: (0, import_jsx_runtime2.jsx)(ArrowRightIcon, {}) }) : (0, import_jsx_runtime2.jsx)(Text, { children: "/" }))
...
var DocumentPanelSubHeader = (0, import_react2.memo)(function() {
  ...
  const backButton = t22, t3 = (displayed == null ? void 0 : displayed._id) ?? documentId, t4 = (displayed == null ? void 0 : displayed._type) ?? "";
  let t5;
  ...
  const t6 = t5.join("."), t7 = ((editState == null ? void 0 : editState.ready) && (editState.version ?? editState.draft ?? editState.published) !== null) ?? false;
  let t8;
  ...
  const favoriteToggle = t8, t9 = connectionState === "connecting" && !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published);
  let t10;
...
var DocumentBox = yt(Box).withConfig({
  displayName: "DocumentBox",
  componentId: "sc-10i0hcs-0"
})({
  position: "relative"
});
var Scroller$4 = yt(ScrollContainer).withConfig({
  displayName: "Scroller",
...
var DocumentPanel = function(props) {
  ...
  let t0;
  $[0] !== activeViewId || $[1] !== views2 ? (t0 = views2.find((view) => view.id === activeViewId) || views2[0] || {
    type: "form"
  }, $[0] = activeViewId, $[1] = views2, $[2] = t0) : t0 = $[2];
  ...
  bb0: {
    ...
    let t22;
    $[6] === Symbol.for("react.memo_cache_sentinel") ? (t22 = [0, 0, 2, 0], $[6] = t22) : t22 = $[6], t1 = t22;
  }
  const margins = t1, formViewHidden = activeView.type !== "form";
  let t2;
  $[7] !== activeView.component || $[8] !== activeView.options || $[9] !== activeView.type || $[10] !== displayed || $[11] !== documentId || $[12] !== (editState == null ? void 0 : editState.draft) || $[13] !== (editState == null ? void 0 : editState.published) || $[14] !== schemaType || $[15] !== value ? (t2 = () => {
    ...
    return false;
  }, $[7] = activeView.component, $[8] = activeView.options, $[9] = activeView.type, $[10] = displayed, $[11] = documentId, $[12] = editState == null ? void 0 : editState.draft, $[13] = editState == null ? void 0 : editState.published, $[14] = schemaType, $[15] = value, $[16] = t2) : t2 = $[16];
  let t3;
  $[17] !== t2 ? (t3 = t2(), $[17] = t2, $[18] = t3) : t3 = $[18];
  const activeViewNode = t3, prevDocumentIdRef = (0, import_react2.useRef)(void 0);
  let t4, t5;
  ...
  }, t5 = [documentId, documentScrollElement], $[19] = documentId, $[20] = documentScrollElement, $[21] = t4, $[22] = t5) : (t4 = $[21], t5 = $[22]), (0, import_react2.useEffect)(t4, t5);
  let t6, t7;
  $[23] !== portalElement || $[24] !== setDocumentPanelPortalElement ? (t6 = () => {
    portalElement && setDocumentPanelPortalElement(portalElement);
  }, t7 = [portalElement, setDocumentPanelPortalElement], $[23] = portalElement, $[24] = setDocumentPanelPortalElement, $[25] = t6, $[26] = t7) : (t6 = $[25], t7 = $[26]), (0, import_react2.useEffect)(t6, t7);
  let t8;
  $[27] !== displayed || $[28] !== isInspectOpen || $[29] !== value ? (t8 = isInspectOpen ? (0, import_jsx_runtime2.jsx)(LegacyLayerProvider, { zOffset: "inspectorDialog", children: (0, import_jsx_runtime2.jsx)(InspectDialog, { value: displayed || value }) }) : null, $[27] = displayed, $[28] = isInspectOpen, $[29] = value, $[30] = t8) : t8 = $[30];
  const inspectDialog = t8, showInspector = !!(!collapsed && inspector), {
    selectedPerspective,
    selectedReleaseId,
    selectedPerspectiveName
  } = usePerspective(), t9 = params == null ? void 0 : params.historyVersion;
  let t10;
  ...
  bb1: {
    if (params == null ? void 0 : params.historyVersion) {
      let t123;
      $[35] === Symbol.for("react.memo_cache_sentinel") ? (t123 = (0, import_jsx_runtime2.jsx)(ArchivedReleaseDocumentBanner, {}), $[35] = t123) : t123 = $[35], t11 = t123;
      break bb1;
    }
    let t122;
    ...
    const isScheduledRelease = t122, documentInScheduledRelease = !!(isScheduledRelease && (displayed == null ? void 0 : displayed._id) && getVersionFromId(displayed == null ? void 0 : displayed._id) === selectedReleaseId);
    ...
    const isPinnedDraftOrPublish = t152, isCurrentVersionGoingToUnpublish = (editState == null ? void 0 : editState.version) && isGoingToUnpublish(editState == null ? void 0 : editState.version);
    if (!isSystemBundle(selectedPerspective) && (displayed == null ? void 0 : displayed._id) && getVersionFromId(displayed._id) !== selectedPerspectiveName && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === false && !isCurrentVersionGoingToUnpublish) {
      let t162;
      $[57] !== isScheduledRelease || $[58] !== selectedPerspective || $[59] !== value._id ? (t162 = (0, import_jsx_runtime2.jsx)(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: selectedPerspective, isScheduledRelease }), $[57] = isScheduledRelease, $[58] = selectedPerspective, $[59] = value._id, $[60] = t162) : t162 = $[60], t11 = t162;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t162;
        $[61] !== displayed || $[62] !== documentId || $[63] !== schemaType ? (t162 = (0, import_jsx_runtime2.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[61] = displayed, $[62] = documentId, $[63] = schemaType, $[64] = t162) : t162 = $[64], t11 = t162;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t162;
        $[65] !== displayed || $[66] !== documentId || $[67] !== schemaType ? (t162 = (0, import_jsx_runtime2.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: true }), $[65] = displayed, $[66] = documentId, $[67] = schemaType, $[68] = t162) : t162 = $[68], t11 = t162;
        break bb1;
      }
    }
  ...
  let t13;
  $[94] !== activeViewNode || $[95] !== banners || $[96] !== documentScrollElement || $[97] !== footer || $[98] !== formViewHidden || $[99] !== inspectDialog || $[100] !== layoutCollapsed || $[101] !== margins || $[102] !== portalElement || $[103] !== portalElements || $[104] !== showFormView ? (t13 = showFormView && (0, import_jsx_runtime2.jsxs)(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
  ...
  let t15;
  return $[111] !== t13 || $[112] !== t14 ? (t15 = (0, import_jsx_runtime2.jsx)(PaneContent, { children: (0, import_jsx_runtime2.jsxs)(Flex, { height: "fill", children: [
    t13,
    t14
...
function resolveMenuNodes(params) {
  ...
  for (let i = 0; i < menuItems.length; i += 1) {
    ...
    item.group && !group && (group = {
      ...
      hideSelectionIndicator: ((_a = item.params) == null ? void 0 : _a.hideSelectionIndicator) === true,
      ...
      type: "item",
      key: `${keyOffset + i}-item`,
      hideSelectionIndicator: ((_b = item.params) == null ? void 0 : _b.hideSelectionIndicator) === true,
      hotkey: item.shortcut,
      icon: item.icon,
      intent: item.intent,
      disabled,
...
function CopyDocumentActions() {
  const $ = (0, import_compiler_runtime2.c)(41), {
    ...
    push: pushToast
  } = useToast(), scheduledDraft = params == null ? void 0 : params.scheduledDraft;
  let t0;
  bb0: {
    ...
    if (selectedPerspectiveName === "published" || (schemaType == null ? void 0 : schemaType.liveEdit)) {
      t0 = documentId;
      break bb0;
    }
    let t12;
  ...
  let t1;
  $[5] !== buildIntentUrl || $[6] !== documentId || $[7] !== documentType || $[8] !== pushToast || $[9] !== resolveIntentLink || $[10] !== scheduledDraft || $[11] !== selectedReleaseId || $[12] !== t2 || $[13] !== telemetry ? (t1 = async () => {
  ...
  }, $[5] = buildIntentUrl, $[6] = documentId, $[7] = documentType, $[8] = pushToast, $[9] = resolveIntentLink, $[10] = scheduledDraft, $[11] = selectedReleaseId, $[12] = t2, $[13] = telemetry, $[14] = t1) : t1 = $[14];
  ...
  let t4;
  $[22] !== t3 ? (t4 = (0, import_jsx_runtime2.jsx)(Button2, { icon: ShareIcon, mode: "bleed", tooltipProps: {
    content: t3
  ...
  let t6;
  $[26] !== handleCopyLink || $[27] !== t5 ? (t6 = (0, import_jsx_runtime2.jsx)(MenuItem2, { icon: LinkIcon, onClick: handleCopyLink, text: t5, "data-testid": "copy-link-to-document" }), $[26] = handleCopyLink, $[27] = t5, $[28] = t6) : t6 = $[28];
  let t7;
  $[29] !== t2 ? (t7 = t2("action.copy-document-id.label"), $[29] = t2, $[30] = t7) : t7 = $[30];
  let t8;
  $[31] !== handleCopyId || $[32] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(MenuItem2, { icon: TargetIcon, onClick: handleCopyId, text: t7, "data-testid": "copy-document-id" }), $[31] = handleCopyId, $[32] = t7, $[33] = t8) : t8 = $[33];
  let t9;
  $[34] !== t6 || $[35] !== t8 ? (t9 = (0, import_jsx_runtime2.jsxs)(Menu, { children: [
    t6,
    t8
  ] }), $[34] = t6, $[35] = t8, $[36] = t9) : t9 = $[36];
  let t10;
  $[37] === Symbol.for("react.memo_cache_sentinel") ? (t10 = {
    portal: true,
    placement: "bottom-end"
  }, $[37] = t10) : t10 = $[37];
  let t11;
  return $[38] !== t4 || $[39] !== t9 ? (t11 = (0, import_jsx_runtime2.jsx)(MenuButton, { id: "copy-document-actions", button: t4, menu: t9, popover: t10 }), $[38] = t4, $[39] = t9, $[40] = t11) : t11 = $[40], t11;
}
...
function NonReleaseVersionsSelect(props) {
  ...
  let t22, t3;
  if ($[5] === Symbol.for("react.memo_cache_sentinel") ? (t22 = (event) => {
  ...
  $[7] !== documentType || $[8] !== getVersionDisplay || $[9] !== onCopyToDraftsNavigate || $[10] !== onSelectBundle || $[11] !== releases || $[12] !== releasesLoading || $[13] !== selectedNonReleaseVersion ? (t4 = selectedNonReleaseVersion && (() => {
    ...
    return (0, import_jsx_runtime2.jsx)(VersionChip$1, { selected: true, text: (versionDisplay == null ? void 0 : versionDisplay.displayName) ?? bundleId, tone: (versionDisplay == null ? void 0 : versionDisplay.tone) ?? "default", onClick: () => onSelectBundle(bundleId), onCopyToDraftsNavigate, contextValues: {
  ...
  if ($[19] !== documentType || $[20] !== getVersionDisplay || $[21] !== onCopyToDraftsNavigate || $[22] !== onSelectBundle || $[23] !== otherNonReleaseVersions || $[24] !== releases || $[25] !== releasesLoading || $[26] !== selectedPerspective) {
    ...
    $[28] !== documentType || $[29] !== getVersionDisplay || $[30] !== onCopyToDraftsNavigate || $[31] !== onSelectBundle || $[32] !== releases || $[33] !== releasesLoading || $[34] !== selectedPerspective ? (t72 = (nonReleaseVersionId) => {
      ...
      return (0, import_jsx_runtime2.jsx)(VersionChip$1, { selected, text: (versionDisplay_0 == null ? void 0 : versionDisplay_0.displayName) ?? bundle, disabled: false, contextMenuPortal: false, tone: (versionDisplay_0 == null ? void 0 : versionDisplay_0.tone) ?? "default", onClick: () => onSelectBundle(bundle), onCopyToDraftsNavigate, contextValues: {
    ...
    t6 = $[27];
  let t7;
  $[36] !== t6 ? (t7 = (0, import_jsx_runtime2.jsx)(Container, { width: 1, children: (0, import_jsx_runtime2.jsx)(Flex, { width: 1, padding: 3, gap: 2, wrap: "wrap", children: t6 }) }), $[36] = t6, $[37] = t7) : t7 = $[37];
  let t8;
  $[38] !== nonReleaseDropdownOpen || $[39] !== popoverReferenceElement || $[40] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(Popover2, { animate: false, open: nonReleaseDropdownOpen, portal: true, arrow: true, ref: popoverRef, placement: "bottom", referenceElement: popoverReferenceElement, zOffset: 10, content: t7 }), $[38] = nonReleaseDropdownOpen, $[39] = popoverReferenceElement, $[40] = t7, $[41] = t8) : t8 = $[41];
  let t9;
  return $[42] !== t4 || $[43] !== t5 || $[44] !== t8 ? (t9 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    t4,
    t5,
    t8
...
var DocumentPerspectiveList = (0, import_react2.memo)(function() {
  ...
  const $ = (0, import_compiler_runtime2.c)(113), {
    selectedReleaseId,
    selectedPerspectiveName
  } = usePerspective(), {
    t: t2
    ...
    documentType,
    documentId
  } = useDocumentPaneInfo(), isCreatingDocument = displayed && !displayed._createdAt, defaultPerspective = useGetDefaultPerspective(), t0 = params == null ? void 0 : params.historyVersion;
  let t1;
  ...
  let t4;
  $[8] !== onSetScheduledDraftPerspective || $[9] !== (params == null ? void 0 : params.scheduledDraft) || $[10] !== setPerspective ? (t4 = () => {
    (params == null ? void 0 : params.scheduledDraft) ? onSetScheduledDraftPerspective("") : setPerspective("drafts");
  }, $[8] = onSetScheduledDraftPerspective, $[9] = params == null ? void 0 : params.scheduledDraft, $[10] = setPerspective, $[11] = t4) : t4 = $[11];
  ...
  $[12] !== defaultPerspective || $[13] !== onSetScheduledDraftPerspective || $[14] !== params || $[15] !== setParams || $[16] !== setPerspective ? (t5 = (perspective) => {
    ...
    (params == null ? void 0 : params.scheduledDraft) ? setParams({
      ...params,
  ...
  bb0: {
    ...
    t7 = !(editState == null ? void 0 : editState.published);
  }
  const isPublishedChipDisabled = t7;
  let t8;
  $[21] !== (displayed == null ? void 0 : displayed._id) || $[22] !== (editState == null ? void 0 : editState.version) || $[23] !== params ? (t8 = (release) => {
    var _a2;
    if (!(params == null ? void 0 : params.historyVersion)) {
      const isCurrentVersionGoingToUnpublish = (editState == null ? void 0 : editState.version) && isGoingToUnpublish(editState == null ? void 0 : editState.version) && getReleaseIdFromReleaseDocumentId(release._id) === getVersionFromId((_a2 = editState == null ? void 0 : editState.version) == null ? void 0 : _a2._id);
      return {
        selected: !!(getReleaseIdFromReleaseDocumentId(release._id) === getVersionFromId((displayed == null ? void 0 : displayed._id) || "") || isCurrentVersionGoingToUnpublish)
      };
    }
  ...
  }, $[21] = displayed == null ? void 0 : displayed._id, $[22] = editState == null ? void 0 : editState.version, $[23] = params, $[24] = t8) : t8 = $[24];
  const getReleaseChipState = t8;
  let t9;
  $[25] !== (displayed == null ? void 0 : displayed._id) || $[26] !== ((_a = editState == null ? void 0 : editState.draft) == null ? void 0 : _a._id) || $[27] !== isLiveEdit || $[28] !== selectedPerspectiveName || $[29] !== selectedReleaseId ? (t9 = () => {
    var _a2;
  ...
  }, $[25] = displayed == null ? void 0 : displayed._id, $[26] = (_b = editState == null ? void 0 : editState.draft) == null ? void 0 : _b._id, $[27] = isLiveEdit, $[28] = selectedPerspectiveName, $[29] = selectedReleaseId, $[30] = t9) : t9 = $[30];
  ...
  bb1: {
    ...
    if (isPublishedId(displayedId) && (editState == null ? void 0 : editState.published) && isPublishedPerspective(selectedPerspectiveName || "")) {
      t10 = false;
      break bb1;
    }
    t10 = true;
  ...
  let t11;
  $[31] !== (editState == null ? void 0 : editState.draft) || $[32] !== isCreatingDocument || $[33] !== isLiveEdit || $[34] !== onlyHasVersions || $[35] !== selectedReleaseId ? (t11 = () => onlyHasVersions || isCreatingDocument && selectedReleaseId ? true : !(editState == null ? void 0 : editState.draft) && !isLiveEdit ? false : !!(isCreatingDocument && selectedReleaseId || isLiveEdit), $[31] = editState == null ? void 0 : editState.draft, $[32] = isCreatingDocument, $[33] = isLiveEdit, $[34] = onlyHasVersions, $[35] = selectedReleaseId, $[36] = t11) : t11 = $[36];
  const isDraftDisabled = t11(), isDraftModelEnabled = (_c = workspace.document.drafts) == null ? void 0 : _c.enabled, {
    filteredVersionIds,
    getVersionDisplay
  ...
  if ($[37] !== filteredReleases.currentReleases || $[38] !== filteredVersionIds) {
    let t132;
    $[40] !== filteredReleases.currentReleases ? (t132 = (versionDocumentId) => isPublishedId(versionDocumentId) || isDraftId(versionDocumentId) ? false : !filteredReleases.currentReleases.some((release_0) => getReleaseIdFromReleaseDocumentId(release_0._id) === getVersionFromId(versionDocumentId)), $[40] = filteredReleases.currentReleases, $[41] = t132) : t132 = $[41], t12 = filteredVersionIds.filter(t132), $[37] = filteredReleases.currentReleases, $[38] = filteredVersionIds, $[39] = t12;
  } else
    t12 = $[39];
  const nonReleaseVersions = t12;
  let t13;
  $[42] !== dateTimeFormat || $[43] !== (editState == null ? void 0 : editState.published) || $[44] !== t2 ? (t13 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (editState == null ? void 0 : editState.published) && ((_d = editState == null ? void 0 : editState.published) == null ? void 0 : _d._updatedAt) ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.published-date", values: {
    date: dateTimeFormat.format(new Date(editState == null ? void 0 : editState.published._updatedAt))
  } }) : (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t2("release.chip.tooltip.not-published") }) }), $[42] = dateTimeFormat, $[43] = editState == null ? void 0 : editState.published, $[44] = t2, $[45] = t13) : t13 = $[45];
  let t14;
  ...
  const t16 = ((_e = editState == null ? void 0 : editState.published) == null ? void 0 : _e._id) || (editState == null ? void 0 : editState.id) || "", t17 = !(editState == null ? void 0 : editState.published);
  let t18;
  ...
  } }) }) : (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t2(isLiveEdit ? "release.chip.tooltip.draft-disabled.live-edit" : "release.chip.tooltip.no-edits") }) }), selected: isDraftSelected, disabled: isDraftDisabled, text: t2("release.chip.draft"), tone: (editState == null ? void 0 : editState.draft) ? "caution" : "neutral", onClick: () => handlePerspectiveChange("drafts"), onCopyToDraftsNavigate: handleCopyToDraftsNavigate, contextValues: {
    documentId: ((_g = editState == null ? void 0 : editState.draft) == null ? void 0 : _g._id) || ((_h = editState == null ? void 0 : editState.published) == null ? void 0 : _h._id) || (editState == null ? void 0 : editState.id) || "",
    documentType,
    releases: filteredReleases.notCurrentReleases,
    releasesLoading: loading,
    bundleId: "draft",
    isVersion: false
  } }), $[64] = dateTimeFormat, $[65] = documentType, $[66] = editState == null ? void 0 : editState.draft, $[67] = editState == null ? void 0 : editState.id, $[68] = (_i = editState == null ? void 0 : editState.published) == null ? void 0 : _i._id, $[69] = filteredReleases.notCurrentReleases, $[70] = handleCopyToDraftsNavigate, $[71] = handlePerspectiveChange, $[72] = isDraftDisabled, $[73] = isDraftModelEnabled, $[74] = isDraftSelected, $[75] = isLiveEdit, $[76] = loading, $[77] = t2, $[78] = t20) : t20 = $[78];
  let t21;
  $[79] !== (displayed == null ? void 0 : displayed._id) || $[80] !== documentType || $[81] !== filteredReleases.inCreation || $[82] !== filteredReleases.notCurrentReleases || $[83] !== handleCopyToDraftsNavigate || $[84] !== loading || $[85] !== t2 ? (t21 = filteredReleases.inCreation && (0, import_jsx_runtime2.jsx)(ReleaseTitle, { title: filteredReleases.inCreation.metadata.title, fallback: t2("release.placeholder-untitled-release"), enableTooltip: false, children: (t2222) => {
    const {
      displayTitle,
      fullTitle,
      isTruncated
  ...
  } }), $[79] = displayed == null ? void 0 : displayed._id, $[80] = documentType, $[81] = filteredReleases.inCreation, $[82] = filteredReleases.notCurrentReleases, $[83] = handleCopyToDraftsNavigate, $[84] = loading, $[85] = t2, $[86] = t21) : t21 = $[86];
  let t222;
  $[87] !== displayed || $[88] !== documentType || $[89] !== (editState == null ? void 0 : editState.version) || $[90] !== filteredReleases.currentReleases || $[91] !== filteredReleases.notCurrentReleases || $[92] !== getReleaseChipState || $[93] !== handleCopyToDraftsNavigate || $[94] !== handlePerspectiveChange || $[95] !== loading || $[96] !== t2 ? (t222 = displayed && ((_j = filteredReleases.currentReleases) == null ? void 0 : _j.map((release_1) => (0, import_jsx_runtime2.jsx)(ReleaseTitle, { title: release_1.metadata.title, fallback: t2("release.placeholder-untitled-release"), enableTooltip: false, children: (t232) => {
    const {
    ...
    return (0, import_jsx_runtime2.jsx)(VersionChip$1, { tooltipContent: isTruncated_0 ? (0, import_jsx_runtime2.jsxs)(Stack, { space: 2, style: {
      ...
      isVersion: true,
      release: release_1,
      isGoingToUnpublish: (editState == null ? void 0 : editState.version) ? isGoingToUnpublish(editState == null ? void 0 : editState.version) : false
    } });
  } }, release_1._id))), $[87] = displayed, $[88] = documentType, $[89] = editState == null ? void 0 : editState.version, $[90] = filteredReleases.currentReleases, $[91] = filteredReleases.notCurrentReleases, $[92] = getReleaseChipState, $[93] = handleCopyToDraftsNavigate, $[94] = handlePerspectiveChange, $[95] = loading, $[96] = t2, $[97] = t222) : t222 = $[97];
  let t23;
  $[98] !== documentType || $[99] !== filteredReleases.notCurrentReleases || $[100] !== getVersionDisplay || $[101] !== handleCopyToDraftsNavigate || $[102] !== handlePerspectiveChange || $[103] !== loading || $[104] !== nonReleaseVersions || $[105] !== selectedPerspectiveName ? (t23 = (0, import_jsx_runtime2.jsx)(NonReleaseVersionsSelect, { nonReleaseVersions, selectedPerspective: selectedPerspectiveName, onSelectBundle: handlePerspectiveChange, onCopyToDraftsNavigate: handleCopyToDraftsNavigate, releases: filteredReleases.notCurrentReleases, releasesLoading: loading, documentType, getVersionDisplay }), $[98] = documentType, $[99] = filteredReleases.notCurrentReleases, $[100] = getVersionDisplay, $[101] = handleCopyToDraftsNavigate, $[102] = handlePerspectiveChange, $[103] = loading, $[104] = nonReleaseVersions, $[105] = selectedPerspectiveName, $[106] = t23) : t23 = $[106];
  let t24;
  return $[107] !== t19 || $[108] !== t20 || $[109] !== t21 || $[110] !== t222 || $[111] !== t23 ? (t24 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    t19,
    t20,
    t21,
    t222,
    t23
  ] }), $[107] = t19, $[108] = t20, $[109] = t21, $[110] = t222, $[111] = t23, $[112] = t24) : t24 = $[112], t24;
});
...
var HorizontalScroller = yt(Card).withConfig({
...
var DocumentPanelHeader = (0, import_react2.memo)((0, import_react2.forwardRef)(function(_props, ref) {
  ...
  const contextMenuNodes = t2, {
    ...
    t: t3
  } = useTranslation(structureLocaleNamespace), isMaximizedPane = (maximizedPane == null ? void 0 : maximizedPane.pane) && typeof maximizedPane.pane == "object" && maximizedPane.pane.type === "document" && maximizedPane.pane.options.id === documentId;
  let t32;
  $[9] !== isMaximizedPane || $[10] !== onSetMaximizedPane || $[11] !== telemetry ? (t32 = () => {
    onSetMaximizedPane == null ? void 0 : onSetMaximizedPane(), isMaximizedPane ? telemetry.log(FocusDocumentPaneCollapsed) : telemetry.log(FocusDocumentPaneClicked);
  }, $[9] = isMaximizedPane, $[10] = onSetMaximizedPane, $[11] = telemetry, $[12] = t32) : t32 = $[12];
  const handleFocusPane = t32;
  let t4;
  $[13] === Symbol.for("react.memo_cache_sentinel") ? (t4 = (0, import_jsx_runtime2.jsx)(DocumentHeaderTitle, {}), $[13] = t4) : t4 = $[13];
  const title = t4;
  let t5;
  ...
  return $[18] !== BackLink2 || $[19] !== backButton || $[20] !== collapsed || $[21] !== connectionState || $[22] !== contextMenuNodes || $[23] !== editState || $[24] !== handleFocusPane || $[25] !== isMaximizedPane || $[26] !== menuButtonNodes || $[27] !== onPaneClose || $[28] !== onPaneSplit || $[29] !== onSetMaximizedPane || $[30] !== ref || $[31] !== referenceElement || $[32] !== schemaType || $[33] !== showGradient || $[34] !== showPaneGroupCloseButton || $[35] !== showSplitPaneButton || $[36] !== showSplitPaneCloseButton || $[37] !== t3 || $[38] !== tabIndex || $[39] !== unstable_languageFilter ? (t6 = (0, import_jsx_runtime2.jsx)(TooltipDelayGroupProvider, { children: collapsed ? (0, import_jsx_runtime2.jsx)(PaneHeader$1, { border: true, ref, loading: connectionState === "connecting" && !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published), title, tabIndex, backButton }) : (0, import_jsx_runtime2.jsx)(Card, { hidden: collapsed, style: {
    ...
    (0, import_jsx_runtime2.jsx)(Box, { flex: "none", paddingRight: 3, children: (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 1, children: [
      ...
      (0, import_jsx_runtime2.jsx)(CopyDocumentActions, {}),
...
var useDeleteAction = (t0) => {
  ...
  let t1;
  $[0] !== version ? (t1 = (version == null ? void 0 : version._id) && getVersionFromId(version._id), $[0] = version, $[1] = t1) : t1 = $[1];
  ...
  bb0: {
    ...
    let t13;
    $[30] !== (draft == null ? void 0 : draft._id) || $[31] !== handleConfirm || $[32] !== id || $[33] !== isConfirmDialogOpen || $[34] !== type ? (t13 = isConfirmDialogOpen && {
      type: "custom",
    ...
    }, $[30] = draft == null ? void 0 : draft._id, $[31] = handleConfirm, $[32] = id, $[33] = isConfirmDialogOpen, $[34] = type, $[35] = t13) : t13 = $[35];
    let t14;
...
var useDiscardChangesAction = (t0) => {
  ...
  const [permissions, isPermissionsLoading] = useDocumentPairPermissions(t2), currentUser = useCurrentUser(), {
    ...
    t: t3
  } = useTranslation(structureLocaleNamespace), isPublished = (displayed == null ? void 0 : displayed._id) && isPublishedId(displayed == null ? void 0 : displayed._id);
  let t32;
...
var usePublishAction = (props) => {
  ...
  let t0;
  $[0] !== version ? (t0 = (version == null ? void 0 : version._id) && getVersionFromId(version._id), $[0] = version, $[1] = t0) : t0 = $[1];
  const bundleId = t0, {
    publish
  } = useDocumentOperation(id, type, bundleId), {
    changesOpen,
  ...
  let t1;
  $[2] !== (editState == null ? void 0 : editState.draft) || $[3] !== (editState == null ? void 0 : editState.published) || $[4] !== (editState == null ? void 0 : editState.version) ? (t1 = (editState == null ? void 0 : editState.version) || (editState == null ? void 0 : editState.draft) || (editState == null ? void 0 : editState.published) || {}, $[2] = editState == null ? void 0 : editState.draft, $[3] = editState == null ? void 0 : editState.published, $[4] = editState == null ? void 0 : editState.version, $[5] = t1) : t1 = $[5];
  ...
  const title = t4, currentPublishRevision = published == null ? void 0 : published._rev, telemetry = useTelemetry();
  let t5;
  ...
  let t9;
  $[47] !== changesOpen || $[48] !== currentPublishRevision || $[49] !== id || $[50] !== publishState || $[51] !== telemetry ? (t9 = [changesOpen, publishState, currentPublishRevision, telemetry, id], $[47] = changesOpen, $[48] = currentPublishRevision, $[49] = id, $[50] = publishState, $[51] = telemetry, $[52] = t9) : t9 = $[52], (0, import_react2.useEffect)(t8, t9);
  const isWaitingToPublish = !!((draft || version) && (publishScheduled || ((_a = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a.enabled) || isPermissionsLoading));
  let t10;
  $[53] !== ((_b = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _b.enabled) || $[54] !== id || $[55] !== isWaitingToPublish || $[56] !== telemetry ? (t10 = () => {
    var _a2;
    if (isWaitingToPublish)
      return telemetry.log(PublishButtonDisabledStart, {
        documentId: id,
        isRemoteEvent: (_a2 = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a2.enabled
      }), () => {
        var _a3;
        telemetry.log(PublishButtonDisabledComplete, {
          documentId: id,
          isRemoteEvent: (_a3 = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a3.enabled
        });
      };
  }, $[53] = (_c = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _c.enabled, $[54] = id, $[55] = isWaitingToPublish, $[56] = telemetry, $[57] = t10) : t10 = $[57];
  const t11 = (_d = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _d.enabled;
  let t12;
  $[58] !== id || $[59] !== isWaitingToPublish || $[60] !== t11 || $[61] !== telemetry ? (t12 = [isWaitingToPublish, telemetry, id, t11], $[58] = id, $[59] = isWaitingToPublish, $[60] = t11, $[61] = telemetry, $[62] = t12) : t12 = $[62], (0, import_react2.useEffect)(t10, t12);
  let t13;
  $[63] !== doPublish || $[64] !== (draft == null ? void 0 : draft._createdAt) || $[65] !== published || $[66] !== revision || $[67] !== syncState.isSyncing || $[68] !== telemetry || $[69] !== validationStatus.isValidating || $[70] !== validationStatus.revision ? (t13 = () => {
  ...
  }, $[63] = doPublish, $[64] = draft == null ? void 0 : draft._createdAt, $[65] = published, $[66] = revision, $[67] = syncState.isSyncing, $[68] = telemetry, $[69] = validationStatus.isValidating, $[70] = validationStatus.revision, $[71] = t13) : t13 = $[71];
  const handle = t13;
  let t14;
  bb0: {
    ...
    if (published && !draft && !version) {
      ...
      const t162 = published == null ? void 0 : published._updatedAt;
      let t172;
    ...
    if (!isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted)) {
      ...
      let t162;
      $[82] !== currentUser ? (t162 = (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessage, { context: "publish-document", currentUser }), $[82] = currentUser, $[83] = t162) : t162 = $[83];
      let t172;
    ...
    const disabled = !!(publishScheduled || ((_e = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _e.enabled) || (publishState == null ? void 0 : publishState.status) === "publishing" || (publishState == null ? void 0 : publishState.status) === "published" || hasValidationErrors || publish.disabled), t15 = disabled || isPermissionsLoading;
    let t16;
    $[87] !== publishScheduled || $[88] !== (publishState == null ? void 0 : publishState.status) || $[89] !== t2 ? (t16 = (publishState == null ? void 0 : publishState.status) === "published" ? t2("action.publish.published.label") : publishScheduled ? t2("action.publish.validation-in-progress.label") : (publishState == null ? void 0 : publishState.status) === "publishing" ? t2("action.publish.running.label") : t2("action.publish.draft.label"), $[87] = publishScheduled, $[88] = publishState == null ? void 0 : publishState.status, $[89] = t2, $[90] = t16) : t16 = $[90];
    let t17;
    $[91] !== publishScheduled || $[92] !== (publishState == null ? void 0 : publishState.status) || $[93] !== t2 || $[94] !== title ? (t17 = publishScheduled ? t2("action.publish.waiting") : (publishState == null ? void 0 : publishState.status) === "published" || (publishState == null ? void 0 : publishState.status) === "publishing" ? null : title, $[91] = publishScheduled, $[92] = publishState == null ? void 0 : publishState.status, $[93] = t2, $[94] = title, $[95] = t17) : t17 = $[95];
...
var useUnpublishAction = (t0) => {
  ...
  bb0: {
    if (isConfirmDialogOpen) {
      const t52 = (draft == null ? void 0 : draft._id) || id;
      let t62;
  ...
  const dialog = t4;
  let t5;
  $[10] !== currentUser || $[11] !== dialog || $[12] !== isDraft || $[13] !== isPermissionsLoading || $[14] !== liveEdit || $[15] !== (permissions == null ? void 0 : permissions.granted) || $[16] !== release || $[17] !== t2 || $[18] !== unpublish.disabled ? (t5 = () => release || isDraft || liveEdit ? null : !isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted) ? {
    tone: "critical",
    icon: UnpublishIcon,
    label: "Unpublish",
    ...
    dialog
  }, $[10] = currentUser, $[11] = dialog, $[12] = isDraft, $[13] = isPermissionsLoading, $[14] = liveEdit, $[15] = permissions == null ? void 0 : permissions.granted, $[16] = release, $[17] = t2, $[18] = unpublish.disabled, $[19] = t5) : t5 = $[19];
  let t6;
...
var DocumentStatusBarActionsInner = (0, import_react2.memo)(function(props) {
  const $ = (0, import_compiler_runtime2.c)(39), {
    ...
    params
  } = usePaneRouter(), showingRevision = !!(params == null ? void 0 : params.rev), {
    selectedReleaseId
  } = usePerspective();
  ...
  const tooltipContent = t0, shouldShowScheduleAsFirstActionButton = (firstActionState == null ? void 0 : firstActionState.action) === "schedule" && isPaused;
  let t1;
  $[11] !== (editState == null ? void 0 : editState.liveEdit) || $[12] !== (editState == null ? void 0 : editState.version) || $[13] !== firstActionState || $[14] !== selectedReleaseId || $[15] !== shouldShowScheduleAsFirstActionButton || $[16] !== showingRevision ? (t1 = showingRevision ? !!firstActionState : selectedReleaseId ? firstActionState && (shouldShowScheduleAsFirstActionButton || !isSanityDefinedAction(firstActionState)) : firstActionState && (!(editState == null ? void 0 : editState.liveEdit) || (editState == null ? void 0 : editState.version)), $[11] = editState == null ? void 0 : editState.liveEdit, $[12] = editState == null ? void 0 : editState.version, $[13] = firstActionState, $[14] = selectedReleaseId, $[15] = shouldShowScheduleAsFirstActionButton, $[16] = showingRevision, $[17] = t1) : t1 = $[17];
...
var DocumentStatusBarActions = (0, import_react2.memo)(function() {
  const $ = (0, import_compiler_runtime2.c)(1);
  let t0;
  return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { group: "default", children: _temp2$c }), $[0] = t0) : t0 = $[0], t0;
});
...
var HistoryStatusBarActions = (0, import_react2.memo)(function() {
  const $ = (0, import_compiler_runtime2.c)(1);
  let t0;
  return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { group: "default", children: _temp4$8 }), $[0] = t0) : t0 = $[0], t0;
});
function RenderHistoryStatusBarActions(t0) {
  ...
  let t1;
  $[0] !== (editState == null ? void 0 : editState.draft) || $[1] !== (editState == null ? void 0 : editState.published) ? (t1 = (editState == null ? void 0 : editState.draft) || (editState == null ? void 0 : editState.published) || {}, $[0] = editState == null ? void 0 : editState.draft, $[1] = editState == null ? void 0 : editState.published, $[2] = t1) : t1 = $[2];
...
var FlipIcon = yt(ChevronLeftIcon).withConfig({
...
var IconBox = yt(Flex).withConfig({
  displayName: "IconBox",
...
var NameSkeleton = yt(Skeleton).withConfig({
...
var Timeline = (t0) => {
  const $ = (0, import_compiler_runtime2.c)(51), {
    ...
    t: t2
  } = useTranslation("studio"), selectedChunkId = selectedChunk == null ? void 0 : selectedChunk.id;
  let t22;
...
var Root$2 = yt(Popover2).withConfig({
  displayName: "Root",
...
var StyledMotionPath = yt(motion.path).withConfig({
...
`;
var RotateGroup = yt.g.withConfig({
...
var FallbackStatus = () => {
  ...
  $[0] !== editState || $[1] !== selectedPerspective ? (t0 = (function() {
    var _a, _b, _c;
    return isPublishedPerspective(selectedPerspective) && ((_a = editState == null ? void 0 : editState.published) == null ? void 0 : _a._updatedAt) ? {
      translationKey: TIMELINE_ITEM_I18N_KEY_MAPPING.published.createDocumentVersion,
      timestamp: editState.published._updatedAt
    } : ((_b = editState == null ? void 0 : editState.version) == null ? void 0 : _b._updatedAt) ? {
    ...
    } : ((_c = editState == null ? void 0 : editState.draft) == null ? void 0 : _c._updatedAt) ? {
...
var TimelineStatus = () => {
  const $ = (0, import_compiler_runtime2.c)(10), {
    timelineStore
  } = useDocumentPane(), chunks = useTimelineSelector(timelineStore, _temp$n), loading = useTimelineSelector(timelineStore, _temp2$a), event = chunks == null ? void 0 : chunks[0];
  if (!event && loading) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime2.jsx)(ButtonSkeleton, {}), $[0] = t02) : t02 = $[0], t02;
  }
...
function DocumentStatusLine() {
  ...
  const $ = (0, import_compiler_runtime2.c)(18), {
    ...
    documentId,
    documentType
  } = useDocumentPaneInfo(), [status, setStatus] = (0, import_react2.useState)(null), eventsEnabled = (_b = (_a = useSource().beta) == null ? void 0 : _a.eventsAPI) == null ? void 0 : _b.documents, syncState = useSyncState(documentId, documentType, editState == null ? void 0 : editState.release), lastUpdated = value == null ? void 0 : value._updatedAt;
  let t0;
...
var StatusText = yt(Text).withConfig({
...
function RevisionStatusLine() {
  const $ = (0, import_compiler_runtime2.c)(9), {
    displayed,
    revisionNotFound
  } = useDocumentPane(), events = (0, import_react2.useContext)(EventsContext), revision = events == null ? void 0 : events.revision, revisionEvent = events == null ? void 0 : events.events.find((ev) => ev.id === (revision == null ? void 0 : revision.revisionId)), {
    t: t2
  } = useTranslation(), date = (revisionEvent == null ? void 0 : revisionEvent.timestamp) || (displayed == null ? void 0 : displayed._updatedAt) || (displayed == null ? void 0 : displayed._createdAt), t0 = "revision", t1 = date ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "document-status.revision-from", values: {
...
function DocumentStatusBar(props) {
  const $ = (0, import_compiler_runtime2.c)(17), {
    ...
    selectedPerspective
  } = usePerspective(), showingRevision = !!params.rev, [collapsed, setCollapsed] = (0, import_react2.useState)(null), [rootElement, setRootElement] = (0, import_react2.useState)(null);
  let t1;
  ...
  if (showingRevision) {
    let t42;
    $[3] === Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime2.jsx)(HistoryStatusBarActions, {}), $[3] = t42) : t42 = $[3], actions = t42;
  } else {
    let t42;
    $[4] === Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime2.jsx)(DocumentStatusBarActions, {}), $[4] = t42) : t42 = $[4], actions = t42;
  }
  if (showingRevision && revisionNotFound)
    return null;
  const t4 = showingRevision ? "revision" : "published";
  let t5;
  $[5] === Symbol.for("react.memo_cache_sentinel") ? (t5 = {
    opacity: 0.2
  }, $[5] = t5) : t5 = $[5];
  let t6;
  ...
  let t8;
  $[7] !== actions || $[8] !== actionsBoxRef || $[9] !== collapsed || $[10] !== shouldRender || $[11] !== showingRevision ? (t8 = shouldRender && (0, import_jsx_runtime2.jsxs)(Flex, { align: "stretch", gap: 1, justify: "space-between", paddingLeft: showingRevision ? 0 : 1, paddingRight: showingRevision ? 0 : 1, children: [
  ...
  let t9;
  return $[13] !== t4 || $[14] !== t7 || $[15] !== t8 ? (t9 = (0, import_jsx_runtime2.jsx)(AnimatedCard, { initial: t5, animate: t6, tone: t7, radius: 3, ref: setRootElement, sizing: "border", padding: 2, children: t8 }, t4), $[13] = t4, $[14] = t7, $[15] = t8, $[16] = t9) : t9 = $[16], t9;
}
...
function DocumentLayoutFooter(t0) {
  ...
  let t2;
  $[2] !== setActionsBoxElement ? (t2 = (0, import_jsx_runtime2.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime2.jsx)(DocumentStatusBar, { actionsBoxRef: setActionsBoxElement }) }), $[2] = setActionsBoxElement, $[3] = t2) : t2 = $[3];
  let t3;
  $[4] !== setFooterElement || $[5] !== t2 ? (t3 = (0, import_jsx_runtime2.jsx)(PaneFooter, { ref: setFooterElement, padding: 1, children: t2 }), $[4] = setFooterElement, $[5] = t2, $[6] = t3) : t3 = $[6];
  let t4;
  $[7] !== t3 || $[8] !== zOffsets.portal ? (t4 = (0, import_jsx_runtime2.jsx)(DialogProvider, { position: DIALOG_PROVIDER_POSITION$1, zOffset: zOffsets.portal, children: t3 }), $[7] = t3, $[8] = zOffsets.portal, $[9] = t4) : t4 = $[9];
  let t5;
  return $[10] !== portalElements || $[11] !== t4 ? (t5 = (0, import_jsx_runtime2.jsx)(PortalProvider, { __unstable_elements: portalElements, children: t4 }), $[10] = portalElements, $[11] = t4, $[12] = t5) : t5 = $[12], t5;
}
var EMPTY_ARRAY$1 = [];
...
var StyledChangeConnectorRoot = yt(ChangeConnectorRoot).withConfig({
...
function DocumentLayout() {
  ...
  let t3;
  $[6] !== (inspector == null ? void 0 : inspector.name) || $[7] !== inspectors2 ? (t3 = inspectors2 == null ? void 0 : inspectors2.find((i) => i.name === (inspector == null ? void 0 : inspector.name)), $[6] = inspector == null ? void 0 : inspector.name, $[7] = inspectors2, $[8] = t3) : t3 = $[8];
  ...
  const t12 = layoutCollapsed ? void 0 : "fill", t13 = changesOpen && (paneParams == null ? void 0 : paneParams.changesInspectorTab) === "review", t14 = footerHeight || null, t15 = headerHeight || null;
  let t16;
...
var DocumentTitle = (t0) => {
  const $ = (0, import_compiler_runtime2.c)(20), {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), isNewDocument2 = !(displayed == null ? void 0 : displayed._createdAt), t1 = !!displayed;
  let t22;
  $[0] !== displayed || $[1] !== schemaType || $[2] !== t1 ? (t22 = {
    enabled: t1,
    schemaType,
    value: displayed
  }, $[0] = displayed, $[1] = schemaType, $[2] = t1, $[3] = t22) : t22 = $[3];
  const {
    value,
    isLoading: previewValueIsLoading
  } = useValuePreview(t22);
  let t3;
  $[4] !== isDeleted || $[5] !== isNewDocument2 || $[6] !== (schemaType == null ? void 0 : schemaType.name) || $[7] !== (schemaType == null ? void 0 : schemaType.title) || $[8] !== t2 || $[9] !== (value == null ? void 0 : value.title) ? (t3 = isDeleted ? "" : isNewDocument2 ? t2("browser-document-title.new-document", {
    schemaType: (schemaType == null ? void 0 : schemaType.title) || (schemaType == null ? void 0 : schemaType.name)
  }) : (value == null ? void 0 : value.title) || t2("browser-document-title.untitled-document"), $[4] = isDeleted, $[5] = isNewDocument2, $[6] = schemaType == null ? void 0 : schemaType.name, $[7] = schemaType == null ? void 0 : schemaType.title, $[8] = t2, $[9] = value == null ? void 0 : value.title, $[10] = t3) : t3 = $[10];
  ...
  let t5;
  return $[15] !== documentTitle || $[16] !== newTitle || $[17] !== previewValueIsLoading || $[18] !== ready ? (t5 = [documentTitle, ready, newTitle, previewValueIsLoading], $[15] = documentTitle, $[16] = newTitle, $[17] = previewValueIsLoading, $[18] = ready, $[19] = t5) : t5 = $[19], (0, import_react2.useEffect)(t4, t5), null;
};
var PassthroughTitle = (props) => {
  ...
  let t1;
  return $[2] !== newTitle || $[3] !== title ? (t1 = [newTitle, title], $[2] = newTitle, $[3] = title, $[4] = t1) : t1 = $[4], (0, import_react2.useEffect)(t0, t1), null;
};
var StructureTitle = (props) => {
  ...
  if (isLoadingPane(lastPane)) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime2.jsx)(PassthroughTitle, {}), $[0] = t02) : t02 = $[0], t02;
  }
  if (isDocumentPane(lastPane)) {
    if (lastPane == null ? void 0 : lastPane.title) {
      let t02;
      return $[1] !== lastPane.title ? (t02 = (0, import_jsx_runtime2.jsx)(PassthroughTitle, { title: lastPane.title }), $[1] = lastPane.title, $[2] = t02) : t02 = $[2], t02;
    }
    return null;
  }
  const t0 = lastPane == null ? void 0 : lastPane.title;
  let t1;
  return $[3] !== t0 ? (t1 = (0, import_jsx_runtime2.jsx)(PassthroughTitle, { title: t0 }), $[3] = t0, $[4] = t1) : t1 = $[4], t1;
};
function useConstructDocumentTitle(activeTitle) {
  const $ = (0, import_compiler_runtime2.c)(3), structureToolBaseTitle = useStructureTool().structureContext.title;
  let t0;
...
var EventsContextFallback = {
  revision: null
};
var useDeletedDocumentLastRevision = () => {
  const $ = (0, import_compiler_runtime2.c)(3), {
    revision
  } = (0, import_react2.useContext)(EventsContext) || EventsContextFallback, t0 = (revision == null ? void 0 : revision.document) || null, t1 = (revision == null ? void 0 : revision.loading) || false;
  let t2;
  return $[0] !== t0 || $[1] !== t1 ? (t2 = {
...
function useDocumentPaneInspector(t0) {
  ...
  let t5;
  $[9] !== inspectorName || $[10] !== inspectors2 ? (t5 = inspectors2 == null ? void 0 : inspectors2.find((i) => i.name === inspectorName), $[9] = inspectorName, $[10] = inspectors2, $[11] = t5) : t5 = $[11];
  const currentInspector = t5;
  let t6;
  $[12] !== inspectors2 ? (t6 = inspectors2.find(_temp$l), $[12] = inspectors2, $[13] = t6) : t6 = $[13];
  const historyInspector = t6, changesOpen = (currentInspector == null ? void 0 : currentInspector.name) === HISTORY_INSPECTOR_NAME;
  let t7;
...
function usePreviewUrl(value) {
  ...
  return $[4] !== resolveProductionUrl ? (t3 = subject.asObservable().pipe(distinctUntilChanged(), debounceTime(500), switchMap((document2) => isSanityDocument2(document2) ? from(resolveProductionUrl({
    document: document2
  })) : of(void 0)), distinctUntilChanged(), catchError(_temp$k)), $[4] = resolveProductionUrl, $[5] = t3) : t3 = $[5], useObservable(t3);
}
...
function DocumentPaneProvider(props) {
  var _a;
  const $ = (0, import_compiler_runtime2.c)(241), {
    children,
    index,
    pane,
    paneKey,
  ...
  const {
    ...
    data: t12
  } = useActiveReleases(), releases = t12 === void 0 ? EMPTY_ARRAY$y : t12, diffViewRouter = useDiffViewRouter();
  let t13;
  ...
  const {
    ...
    inspectOpen,
    handleLegacyInspectClose
  } = useDocumentPaneInspector(t14), [isDeleting, setIsDeleting] = (0, import_react2.useState)(false), {
    lastRevisionDocument
  } = useDeletedDocumentLastRevision();
  let t15;
  $[17] !== isPristine || $[18] !== timelineReady ? (t15 = (editState) => timelineReady ? !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published) && !(editState == null ? void 0 : editState.version) && !isPristine : false, $[17] = isPristine, $[18] = timelineReady, $[19] = t15) : t15 = $[19];
  ...
  let t20;
  $[40] !== params.path ? (t20 = params.path ? fromString(params.path) : EMPTY_ARRAY$y, $[40] = params.path, $[41] = t20) : t20 = $[41];
  ...
  let t30;
  $[86] !== getDisplayed || $[87] !== value_0 ? (t30 = getDisplayed(value_0), $[86] = getDisplayed, $[87] = value_0, $[88] = t30) : t30 = $[88];
  const displayed = t30;
  let t31;
  $[89] !== displayed || $[90] !== documentId || $[91] !== editState_1 ? (t31 = {
    strict: true,
    displayed,
    documentId,
    editState: editState_1
  }, $[89] = displayed, $[90] = documentId, $[91] = editState_1, $[92] = t31) : t31 = $[92];
  const {
    previousId
  } = useDocumentIdStack(t31);
  let t32;
  $[93] !== params || $[94] !== setPaneParams ? (t32 = (newSince, newRev) => {
    setPaneParams({
      ...params,
      since: newSince,
      rev: newRev || void 0
    });
  }, $[93] = params, $[94] = setPaneParams, $[95] = t32) : t32 = $[95];
  const setTimelineRange = t32;
  let t33;
  $[96] !== paneRouter ? (t33 = () => paneRouter.closeCurrent(), $[96] = paneRouter, $[97] = t33) : t33 = $[97];
  const handlePaneClose = t33;
  let t34;
  $[98] !== paneRouter ? (t34 = () => paneRouter.duplicateCurrent(), $[98] = paneRouter, $[99] = t34) : t34 = $[99];
  const handlePaneSplit = t34;
  let t35;
  $[100] !== router2 || $[101] !== telemetry ? (t35 = () => {
  ...
  }), true) : item.action === "toggleInlineChanges" ? (toggleInlineChanges(), true) : false), $[103] = diffViewRouter, $[104] = documentType, $[105] = handleHistoryOpen, $[106] = handleInspectorAction, $[107] = previewUrl, $[108] = previousId, $[109] = toggleInlineChanges, $[110] = value_0._id, $[111] = t36) : t36 = $[111];
  const handleMenuAction = t36;
  let t37, t38;
  $[112] !== documentId || $[113] !== documentType || $[114] !== onChange || $[115] !== schemaType || $[116] !== setDocumentMeta ? (t37 = () => {
    setDocumentMeta({
      documentId,
      documentType,
      schemaType,
  ...
  }, t38 = [documentId, documentType, schemaType, onChange, setDocumentMeta], $[112] = documentId, $[113] = documentType, $[114] = onChange, $[115] = schemaType, $[116] = setDocumentMeta, $[117] = t37, $[118] = t38) : (t37 = $[117], t38 = $[118]), (0, import_react2.useEffect)(t37, t38);
  let t39;
  $[119] !== getComparisonValue || $[120] !== upstreamEditState_0 ? (t39 = getComparisonValue(upstreamEditState_0), $[119] = getComparisonValue, $[120] = upstreamEditState_0, $[121] = t39) : t39 = $[121];
  ...
  $[124] !== actions || $[125] !== activeViewId || $[126] !== badges || $[127] !== changesOpen || $[128] !== closeInspector || $[129] !== collapsedFieldSets || $[130] !== collapsedPaths || $[131] !== compareValue || $[132] !== connectionState || $[133] !== currentDisplayed || $[134] !== documentId || $[135] !== documentIdRaw || $[136] !== documentType || $[137] !== editState_1 || $[138] !== fieldActions || $[139] !== focusPath || $[140] !== formState || $[141] !== handleHistoryClose || $[142] !== handleHistoryOpen || $[143] !== handleLegacyInspectClose || $[144] !== handleMenuAction || $[145] !== handlePaneClose || $[146] !== handlePaneSplit || $[147] !== handlePathOpen || $[148] !== hasUpstreamVersion || $[149] !== index || $[150] !== inspectOpen || $[151] !== inspectors2 || $[152] !== isDeleted_1 || $[153] !== isDeleting || $[154] !== isInitialValueLoading || $[155] !== isPermissionsLoading || $[156] !== languageFilter || $[157] !== lastNonDeletedRevId || $[158] !== lastRevisionDocument || $[159] !== maximized || $[160] !== onBlur || $[161] !== onChange || $[162] !== onFocus || $[163] !== onSetActiveFieldGroup || $[164] !== onSetCollapsedFieldSet || $[165] !== onSetCollapsedPath || $[166] !== onSetMaximizedPane || $[167] !== openInspector || $[168] !== openPath || $[169] !== paneKey || $[170] !== permissions || $[171] !== previewUrl || $[172] !== ready || $[173] !== revisionId || $[174] !== revisionNotFound || $[175] !== schemaType || $[176] !== selectedReleaseId || $[177] !== setTimelineRange || $[178] !== t41 || $[179] !== t42 || $[180] !== timelineError || $[181] !== timelineStore || $[182] !== title || $[183] !== validation || $[184] !== value_0 || $[185] !== views2 ? (t43 = {
    ...
    lastNonDeletedRevId,
    lastRevisionDocument
  }, $[124] = actions, $[125] = activeViewId, $[126] = badges, $[127] = changesOpen, $[128] = closeInspector, $[129] = collapsedFieldSets, $[130] = collapsedPaths, $[131] = compareValue, $[132] = connectionState, $[133] = currentDisplayed, $[134] = documentId, $[135] = documentIdRaw, $[136] = documentType, $[137] = editState_1, $[138] = fieldActions, $[139] = focusPath, $[140] = formState, $[141] = handleHistoryClose, $[142] = handleHistoryOpen, $[143] = handleLegacyInspectClose, $[144] = handleMenuAction, $[145] = handlePaneClose, $[146] = handlePaneSplit, $[147] = handlePathOpen, $[148] = hasUpstreamVersion, $[149] = index, $[150] = inspectOpen, $[151] = inspectors2, $[152] = isDeleted_1, $[153] = isDeleting, $[154] = isInitialValueLoading, $[155] = isPermissionsLoading, $[156] = languageFilter, $[157] = lastNonDeletedRevId, $[158] = lastRevisionDocument, $[159] = maximized, $[160] = onBlur, $[161] = onChange, $[162] = onFocus, $[163] = onSetActiveFieldGroup, $[164] = onSetCollapsedFieldSet, $[165] = onSetCollapsedPath, $[166] = onSetMaximizedPane, $[167] = openInspector, $[168] = openPath, $[169] = paneKey, $[170] = permissions, $[171] = previewUrl, $[172] = ready, $[173] = revisionId, $[174] = revisionNotFound, $[175] = schemaType, $[176] = selectedReleaseId, $[177] = setTimelineRange, $[178] = t41, $[179] = t42, $[180] = timelineError, $[181] = timelineStore, $[182] = title, $[183] = validation, $[184] = value_0, $[185] = views2, $[186] = t43) : t43 = $[186];
  const documentPane = t43;
  let t44;
  $[187] !== menuItemGroups ? (t44 = menuItemGroups || [], $[187] = menuItemGroups, $[188] = t44) : t44 = $[188];
  let t45;
  $[189] !== actions || $[190] !== badges || $[191] !== documentId || $[192] !== documentIdRaw || $[193] !== documentType || $[194] !== fieldActions || $[195] !== handlePaneClose || $[196] !== handlePaneSplit || $[197] !== index || $[198] !== languageFilter || $[199] !== maximized || $[200] !== onSetMaximizedPane || $[201] !== paneKey || $[202] !== schemaType || $[203] !== t44 || $[204] !== title || $[205] !== views2 ? (t45 = {
    actions,
    badges,
    documentId,
    documentIdRaw,
    ...
    views: views2,
    unstable_languageFilter: languageFilter
  }, $[189] = actions, $[190] = badges, $[191] = documentId, $[192] = documentIdRaw, $[193] = documentType, $[194] = fieldActions, $[195] = handlePaneClose, $[196] = handlePaneSplit, $[197] = index, $[198] = languageFilter, $[199] = maximized, $[200] = onSetMaximizedPane, $[201] = paneKey, $[202] = schemaType, $[203] = t44, $[204] = title, $[205] = views2, $[206] = t45) : t45 = $[206];
  const documentPaneInfo = t45, pathRef = (0, import_react2.useRef)(void 0), paramPath = params.path;
  let t46;
  $[207] !== formStateRef || $[208] !== onProgrammaticFocus || $[209] !== openPath ? (t46 = (urlPath) => {
    var _a2;
    const currentOpenPathString = pathToString$1(openPath);
    if (urlPath !== pathRef.current && urlPath !== currentOpenPathString) {
      const pathFromUrl = resolveKeyedPath((_a2 = formStateRef.current) == null ? void 0 : _a2.value, fromString(urlPath));
      onProgrammaticFocus(pathFromUrl);
    }
  }, $[207] = formStateRef, $[208] = onProgrammaticFocus, $[209] = openPath, $[210] = t46) : t46 = $[210];
  const syncPathFromUrl = (0, import_react2.useEffectEvent)(t46);
  let t47;
  $[211] !== paramPath || $[212] !== ready || $[213] !== syncPathFromUrl ? (t47 = () => {
    ready && paramPath && syncPathFromUrl(paramPath), pathRef.current = paramPath;
  }, $[211] = paramPath, $[212] = ready, $[213] = syncPathFromUrl, $[214] = t47) : t47 = $[214];
  let t48;
  $[215] !== paramPath || $[216] !== ready ? (t48 = [paramPath, ready], $[215] = paramPath, $[216] = ready, $[217] = t48) : t48 = $[217], (0, import_react2.useEffect)(t47, t48);
  const t49 = ((_a = (0, import_react2.useContext)(DocumentDivergencesContext)) == null ? void 0 : _a.enabled) ?? advancedVersionControlEnabled;
  let t50;
  $[218] !== onProgrammaticFocus ? (t50 = (0, import_jsx_runtime2.jsx)(DivergenceAutofocus, { onProgrammaticFocus }), $[218] = onProgrammaticFocus, $[219] = t50) : t50 = $[219];
  let t51;
  $[220] !== displayed || $[221] !== isDeleted_1 || $[222] !== ready || $[223] !== schemaType ? (t51 = (0, import_jsx_runtime2.jsx)(DocumentTitle, { isDeleted: isDeleted_1, displayed, ready, schemaType }), $[220] = displayed, $[221] = isDeleted_1, $[222] = ready, $[223] = schemaType, $[224] = t51) : t51 = $[224];
  let t52;
  $[225] !== children || $[226] !== documentId || $[227] !== editState_1 || $[228] !== formState || $[229] !== t49 || $[230] !== t50 || $[231] !== t51 || $[232] !== upstreamEditState_0 || $[233] !== value_0._id ? (t52 = (0, import_jsx_runtime2.jsxs)(DivergencesProvider, { enabled: t49, upstreamEditState: upstreamEditState_0, editState: editState_1, subjectId: documentId, schemaType: formState.schemaType, displayedId: value_0._id, formState, children: [
    t50,
    t51,
    children
  ] }), $[225] = children, $[226] = documentId, $[227] = editState_1, $[228] = formState, $[229] = t49, $[230] = t50, $[231] = t51, $[232] = upstreamEditState_0, $[233] = value_0._id, $[234] = t52) : t52 = $[234];
  let t53;
  $[235] !== documentPane || $[236] !== t52 ? (t53 = (0, import_jsx_runtime2.jsx)(DocumentPaneContext.Provider, { value: documentPane, children: t52 }), $[235] = documentPane, $[236] = t52, $[237] = t53) : t53 = $[237];
  let t54;
  return $[238] !== documentPaneInfo || $[239] !== t53 ? (t54 = (0, import_jsx_runtime2.jsx)(DocumentPaneInfoContext.Provider, { value: documentPaneInfo, children: t53 }), $[238] = documentPaneInfo, $[239] = t53, $[240] = t54) : t54 = $[240], t54;
}
function getDocumentVersionType(params, selectedReleaseId, value, selectedPerspectiveName, draftsEnabled, releases) {
  let version;
  switch (true) {
    case !!(params == null ? void 0 : params.rev):
      version = "revision";
      break;
...
var DivergenceAutofocus = (t0) => {
  ...
  const focusDivergentPath = (0, import_react2.useEffectEvent)(t1);
  let t2;
  $[4] !== focusDivergentPath ? (t2 = () => {
    focusDivergentPath();
  }, $[4] = focusDivergentPath, $[5] = t2) : t2 = $[5];
  let t3;
  return $[6] !== focusedDivergence ? (t3 = [focusedDivergence], $[6] = focusedDivergence, $[7] = t3) : t3 = $[7], (0, import_react2.useEffect)(t2, t3), null;
};
var DocumentEventsPane = (props) => {
  ...
  const eventsStore = useEventsStore(t3), t4 = eventsStore.error, t5 = ((_b = eventsStore.revision) == null ? void 0 : _b.revisionId) || null, t6 = !!(rev && !((_c = eventsStore.revision) == null ? void 0 : _c.loading)), t7 = ((_d = eventsStore.revision) == null ? void 0 : _d.document) || null, t8 = ((_e = eventsStore.sinceRevision) == null ? void 0 : _e.document) || null, t9 = !eventsStore.loading, t10 = eventsStore.events.length === 0;
  let t11;
...
var DocumentPaneWithLegacyTimelineStore = (props) => {
  ...
  const store = useTimelineStore(t1), onOlderRevision = useTimelineSelector(store, _temp$j), revTime = useTimelineSelector(store, _temp2$9), sinceAttributes = useTimelineSelector(store, _temp3$6), timelineDisplayed = useTimelineSelector(store, _temp4$6), timelineReady = useTimelineSelector(store, _temp5$3), isPristine = useTimelineSelector(store, _temp6$3), lastNonDeletedRevId = useTimelineSelector(store, _temp7$2), t2 = (revTime == null ? void 0 : revTime.id) || null, t3 = timelineDisplayed, t4 = sinceAttributes, t5 = !!isPristine;
  let t6;
...
var DocumentPaneProviderWrapper = (0, import_react2.memo)((props) => {
  ...
  let t1;
  $[3] !== props || $[4] !== ((_b = (_a = source.beta) == null ? void 0 : _a.eventsAPI) == null ? void 0 : _b.documents) ? (t1 = ((_d = (_c = source.beta) == null ? void 0 : _c.eventsAPI) == null ? void 0 : _d.documents) ? (0, import_jsx_runtime2.jsx)(DocumentEventsPane, { ...props }) : (0, import_jsx_runtime2.jsx)(DocumentPaneWithLegacyTimelineStore, { ...props }), $[3] = props, $[4] = (_f = (_e = source.beta) == null ? void 0 : _e.eventsAPI) == null ? void 0 : _f.documents, $[5] = t1) : t1 = $[5];
  let t2;
...
function DocumentPaneInner(props) {
  ...
  let t3;
  $[11] !== groupIndex || $[12] !== routerPanesState ? (t3 = ((_a = routerPanesState[groupIndex + 1]) == null ? void 0 : _a[0].params) || {}, $[11] = groupIndex, $[12] = routerPanesState, $[13] = t3) : t3 = $[13];
...
var ReferenceChildLink = (0, import_react2.forwardRef)(function(t0, ref) {
  ...
  const t2 = template == null ? void 0 : template.params;
  let t3;
...
function PaneRouterProvider(props) {
  const $ = (0, import_compiler_runtime2.c)(60), {
    ...
    panes,
    expand
  } = usePaneLayout(), routerPaneGroups = (routerState == null ? void 0 : routerState.panes) || emptyArray, lastPane = panes == null ? void 0 : panes[panes.length - 2], groupIndex = index - 1;
  let t0;
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./index2-LIODKZAX.js")),
  document: (0, import_react2.lazy)(() => import("./pane-ZXYG3P7K.js")),
  documentList: (0, import_react2.lazy)(() => import("./pane2-XCYZYHMK.js")),
  list: (0, import_react2.lazy)(() => import("./index3-IQQA4PLF.js"))
};
...
var DocumentIdFlex = yt(Flex).withConfig({
...
function ReferencePreviewLink(props) {
  ...
  $[2] !== ReferenceChildLink2 || $[3] !== (type == null ? void 0 : type.name) || $[4] !== (value == null ? void 0 : value._id) ? (t2 = function(linkProps) {
    return (0, import_jsx_runtime2.jsx)(ReferenceChildLink2, { documentId: value == null ? void 0 : value._id, documentType: type == null ? void 0 : type.name, parentRefPath: EMPTY_ARRAY, ...linkProps });
  }, $[2] = ReferenceChildLink2, $[3] = type == null ? void 0 : type.name, $[4] = value == null ? void 0 : value._id, $[5] = t2) : t2 = $[5];
  const t3 = t2, t4 = type == null ? void 0 : type.icon, t5 = (documentPresence == null ? void 0 : documentPresence.length) > 0 ? documentPresence : EMPTY_ARRAY;
  let t6;
...
var EllipsisText = yt(Text).withConfig({
...
var VersionItemPreview = (t0) => {
  ...
  let t10;
  $[25] !== t9 ? (t10 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(ReleaseAvatarIcon, { release: t9 }) }), $[25] = t9, $[26] = t10) : t10 = $[26];
  let t11;
  $[27] !== documentVariant || $[28] !== ((_a = release == null ? void 0 : release.metadata) == null ? void 0 : _a.title) || $[29] !== systemTitle || $[30] !== versionId ? (t11 = documentVariant === "version" ? (0, import_jsx_runtime2.jsx)(ReleaseTitle, { title: (_b = release == null ? void 0 : release.metadata) == null ? void 0 : _b.title, fallback: getVersionFromId(versionId), children: _temp$g }) : (0, import_jsx_runtime2.jsx)(EllipsisText, { size: 1, weight: "medium", textOverflow: "ellipsis", children: systemTitle }), $[27] = documentVariant, $[28] = (_c = release == null ? void 0 : release.metadata) == null ? void 0 : _c.title, $[29] = systemTitle, $[30] = versionId, $[31] = t11) : t11 = $[31];
  let t12;
  $[32] !== t10 || $[33] !== t11 ? (t12 = (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 2, paddingY: 2, paddingRight: 3, paddingLeft: 2, children: [
    t10,
    t11
  ] }), $[32] = t10, $[33] = t11, $[34] = t12) : t12 = $[34];
  let t13;
  $[35] !== t12 || $[36] !== tone ? (t13 = (0, import_jsx_runtime2.jsx)(Card, { border: true, radius: "full", children: (0, import_jsx_runtime2.jsx)(Card, { radius: "full", tone, style: t8, children: t12 }) }), $[35] = t12, $[36] = tone, $[37] = t13) : t13 = $[37];
  let t14;
  return $[38] !== previewIsLoading || $[39] !== schemaType.icon || $[40] !== t13 || $[41] !== t7 ? (t14 = (0, import_jsx_runtime2.jsx)(SanityDefaultPreview, { ...t7, isPlaceholder: previewIsLoading, icon: schemaType.icon, layout: "default", status: t13 }), $[38] = previewIsLoading, $[39] = schemaType.icon, $[40] = t13, $[41] = t7, $[42] = t14) : t14 = $[42], t14;
};
var VersionsPreviewList = (t0) => {
  ...
  let t2;
  $[3] !== documentVersions || $[4] !== schemaType ? (t2 = documentVersions == null ? void 0 : documentVersions.map((version) => (0, import_jsx_runtime2.jsx)(VersionItemPreview, { versionId: version, schemaType }, version)), $[3] = documentVersions, $[4] = schemaType, $[5] = t2) : t2 = $[5];
  let t3;
...
function ConfirmDeleteDialogBody(t0) {
  ...
  let t10;
  $[24] === Symbol.for("react.memo_cache_sentinel") ? (t10 = (0, import_jsx_runtime2.jsx)(Card, { borderTop: true, padding: 1 }), $[24] = t10) : t10 = $[24];
  let t11;
  $[25] === Symbol.for("react.memo_cache_sentinel") ? (t11 = (0, import_jsx_runtime2.jsx)(Text, { "aria-hidden": "true", size: 1, children: (0, import_jsx_runtime2.jsx)(WarningOutlineIcon, {}) }), $[25] = t11) : t11 = $[25];
  let t12;
  ...
  $[43] !== crossDatasetReferences || $[44] !== datasetSubtitle || $[45] !== documentId || $[46] !== internalReferences.totalCount || $[47] !== normalizedDatasetNames.length || $[48] !== t2 || $[49] !== toast ? (t18 = crossDatasetReferences.totalCount > 0 && (0, import_jsx_runtime2.jsxs)(CrossDatasetReferencesDetails, { "data-testid": "cross-dataset-references", style: {
    ...
    (0, import_jsx_runtime2.jsxs)(Box, { overflow: "auto", paddingTop: 2, children: [
      (0, import_jsx_runtime2.jsxs)(Table, { children: [
        ...
        (0, import_jsx_runtime2.jsx)("tbody", { children: crossDatasetReferences.references.filter(_temp$f).map((t192, index) => {
          const {
            projectId,
            datasetName,
...
function useReferringDocuments(documentId) {
  ...
  let t3;
  $[8] !== (crossDatasetReferences == null ? void 0 : crossDatasetReferences.references) ? (t3 = () => Array.from(new Set(crossDatasetReferences == null ? void 0 : crossDatasetReferences.references.map(_temp$e).filter(Boolean))).sort(), $[8] = crossDatasetReferences == null ? void 0 : crossDatasetReferences.references, $[9] = t3) : t3 = $[9];
  let t4;
  $[10] !== t3 ? (t4 = t3(), $[10] = t3, $[11] = t4) : t4 = $[11];
  const projectIds = t4;
  let t5;
  $[12] !== (crossDatasetReferences == null ? void 0 : crossDatasetReferences.references) ? (t5 = Array.from(new Set(crossDatasetReferences == null ? void 0 : crossDatasetReferences.references.map(_temp2$8).filter(_temp3$5))).sort(), $[12] = crossDatasetReferences == null ? void 0 : crossDatasetReferences.references, $[13] = t5) : t5 = $[13];
  const datasetNames = t5;
  let t6;
  $[14] !== (crossDatasetReferences == null ? void 0 : crossDatasetReferences.references) ? (t6 = () => !!(crossDatasetReferences == null ? void 0 : crossDatasetReferences.references.some(_temp4$5)), $[14] = crossDatasetReferences == null ? void 0 : crossDatasetReferences.references, $[15] = t6) : t6 = $[15];
  const hasUnknownDatasetNames = t6(), t7 = ((internalReferences == null ? void 0 : internalReferences.totalCount) || 0) + ((crossDatasetReferences == null ? void 0 : crossDatasetReferences.totalCount) || 0), t8 = isInternalReferencesLoading || isCrossDatasetReferencesLoading;
  let t9;
...
var DialogBody = yt(Box).withConfig({
  displayName: "DialogBody",
...
function PaneHeaderCreateButton(t0) {
  var _a;
  const $ = (0, import_compiler_runtime2.c)(59), {
    templateItems
  ...
  const [templatePermissions, isTemplatePermissionsLoading] = useTemplatePermissions(t22), nothingGranted = !isTemplatePermissionsLoading && (templatePermissions == null ? void 0 : templatePermissions.length) !== 0 && (templatePermissions == null ? void 0 : templatePermissions.every(_temp$d));
  let t3;
  bb0: {
  ...
  if (templateItems.length === 1) {
    ...
    const t62 = t52.title;
    let t72;
    $[22] !== t2 ? (t72 = t2("pane-header.create-new-button.tooltip"), $[22] = t2, $[23] = t72) : t72 = $[23];
    let t82;
    $[24] !== t72 ? (t82 = {
      content: t72
    }, $[24] = t72, $[25] = t82) : t82 = $[25];
    let t9;
    $[26] !== disabled || $[27] !== intent || $[28] !== t52.title || $[29] !== t82 ? (t9 = (0, import_jsx_runtime2.jsx)(IntentButton, { "aria-label": t62, icon: AddIcon, intent, mode: "bleed", disabled, "data-testid": "action-intent-button", tooltipProps: t82 }), $[26] = disabled, $[27] = intent, $[28] = t52.title, $[29] = t82, $[30] = t9) : t9 = $[30];
    let t10;
    return $[31] !== disabled || $[32] !== isTemplatePermissionsLoading || $[33] !== t9 ? (t10 = (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessageTooltip, { reveal: disabled, loading: isTemplatePermissionsLoading, context: "create-document-type", children: t9 }), $[31] = disabled, $[32] = isTemplatePermissionsLoading, $[33] = t9, $[34] = t10) : t10 = $[34], t10;
  }
  let t4;
  $[35] !== t2 ? (t4 = t2("pane-header.create-new-button.tooltip"), $[35] = t2, $[36] = t4) : t4 = $[36];
  let t5;
  $[37] !== t4 ? (t5 = (0, import_jsx_runtime2.jsx)(Button2, { icon: AddIcon, mode: "bleed", "data-testid": "multi-action-intent-button", tooltipProps: {
    content: t4
  } }), $[37] = t4, $[38] = t5) : t5 = $[38];
  let t6;
  if ($[39] !== getI18nText || $[40] !== isTemplatePermissionsLoading || $[41] !== permissionsById || $[42] !== selectedReleaseId || $[43] !== t2 || $[44] !== templateItems || $[45] !== templates) {
    let t72;
    $[47] !== getI18nText || $[48] !== isTemplatePermissionsLoading || $[49] !== permissionsById || $[50] !== selectedReleaseId || $[51] !== t2 || $[52] !== templates ? (t72 = (item, itemIndex) => {
      var _a2;
      ...
      return (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessageTooltip, { context: "create-document-type", reveal: disabled_0, loading: isTemplatePermissionsLoading, children: (0, import_jsx_runtime2.jsx)(MenuItem2, { as: Link2, "data-as": disabled_0 ? "button" : "a", icon: item.icon, text: title, "aria-label": disabled_0 ? t2("pane-header.disabled-created-button.aria-label") : title, disabled: disabled_0, "data-testid": `action-intent-button-${itemIndex}` }) }, item.id);
    }, $[47] = getI18nText, $[48] = isTemplatePermissionsLoading, $[49] = permissionsById, $[50] = selectedReleaseId, $[51] = t2, $[52] = templates, $[53] = t72) : t72 = $[53], t6 = templateItems.map(t72), $[39] = getI18nText, $[40] = isTemplatePermissionsLoading, $[41] = permissionsById, $[42] = selectedReleaseId, $[43] = t2, $[44] = templateItems, $[45] = templates, $[46] = t6;
  } else
    t6 = $[46];
  let t7;
  $[54] !== t6 ? (t7 = (0, import_jsx_runtime2.jsx)(Menu, { children: t6 }), $[54] = t6, $[55] = t7) : t7 = $[55];
  let t8;
  return $[56] !== t5 || $[57] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(MenuButton, { button: t5, id: "create-menu", menu: t7, popover: POPOVER_PROPS }), $[56] = t5, $[57] = t7, $[58] = t8) : t8 = $[58], t8;
}
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t22 || $[14] !== t5 ? (t6 = (0, import_jsx_runtime2.jsx)(SanityDefaultPreview, { title: t22, subtitle: t5, media: _temp$b, layout }), $[12] = layout, $[13] = t22, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$b() {
...
function PaneItem(props) {
  ...
  bb0: {
    ...
    let t32;
    $[14] === Symbol.for("react.memo_cache_sentinel") ? (t32 = (0, import_jsx_runtime2.jsx)(Box, { style: t22, children: (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: (0, import_jsx_runtime2.jsx)(ChevronRightIcon, {}) }) }), $[14] = t32) : t32 = $[14];
    let t42;
  ...
  const preview = t1;
  let t2;
  $[21] === Symbol.for("react.memo_cache_sentinel") ? (t2 = (e2) => {
    if (e2.metaKey) {
      setClicked(false);
      return;
    }
  ...
  const handleClick = t2;
  let t3;
  $[22] === Symbol.for("react.memo_cache_sentinel") ? (t3 = () => setClicked(false), $[22] = t3) : t3 = $[22];
  let t4;
  ...
  let t10;
  $[27] !== id || $[28] !== preloading || $[29] !== schemaType || $[30] !== value ? (t10 = preloading && (schemaType == null ? void 0 : schemaType.name) && value && isSanityDocument(value) && (0, import_jsx_runtime2.jsx)(PreloadDocumentPane, { documentId: id, documentType: schemaType.name }), $[27] = id, $[28] = preloading, $[29] = schemaType, $[30] = value, $[31] = t10) : t10 = $[31];
  let t11;
...
function getIncomingReferences({
  ...
  return (typeof filterQueryRaw == "function" ? documentPreviewStore.unstable_observeDocument(documentId).pipe(distinctUntilChanged((a, b) => (a == null ? void 0 : a._rev) === (b == null ? void 0 : b._rev)), switchMap((document2) => resolveRawFilterCallback(filterQueryRaw, {
    document: document2,
    getClient
  })), map((resolvedFilter) => ({
...
var IncomingReferencesListContainer = yt(Box).withConfig({
...
function CrossDatasetIncomingReferenceDocumentPreview(t0) {
  ...
  let t1;
  $[0] !== document2.id || $[1] !== document2.type || $[2] !== type ? (t1 = (_a = type == null ? void 0 : type.studioUrl) == null ? void 0 : _a.call(type, {
    id: document2.id,
    type: document2.type
  ...
  $[6] !== document2.preview || $[7] !== type ? (t9 = type ? {
    type: type.type,
    title: (_b = document2.preview.published) == null ? void 0 : _b.title,
    icon: _temp$a,
...
function getCrossDatasetIncomingReferences({
  ...
  return fetchCrossDatasetReferences(documentId, {
    ...
    map((result) => result ? (type == null ? void 0 : type.dataset) ? result.references.filter((ref) => ref.datasetName === type.dataset && ref.documentId) : result.references.filter((ref) => ref.documentId && ref.datasetName) : []),
...
function IncomingReferencePreview(props) {
  ...
  let t2;
  $[2] !== ChildLink2 || $[3] !== path || $[4] !== type.name || $[5] !== (value == null ? void 0 : value._id) ? (t2 = function(linkProps) {
    return (0, import_jsx_runtime2.jsx)(ChildLink2, { childId: getPublishedId(value == null ? void 0 : value._id), childParameters: {
      type: type.name,
      path: pathToString$1(path)
    }, ...linkProps });
  }, $[2] = ChildLink2, $[3] = path, $[4] = type.name, $[5] = value == null ? void 0 : value._id, $[6] = t2) : t2 = $[6];
...
var BUILT_IN_SORT_FIELDS = /* @__PURE__ */ new Set(["_id", "_type", "_rev", "_createdAt", "_updatedAt"]);
...
function useDocumentList(opts) {
  ...
  const typeNameFromFilter = t0, [t1] = (0, import_react2.useState)(_temp$8), [onRetry$, onRetry] = t1, [t2] = (0, import_react2.useState)(_temp2$5), [onFetchFullList$, onLoadFullList] = t2, t3 = searchQuery || "", t4 = sortOrder || DEFAULT_ORDERING;
  let t5;
  if ($[3] !== client || $[4] !== maxFieldDepth || $[5] !== onFetchFullList$ || $[6] !== onRetry$ || $[7] !== paramsProp || $[8] !== perspective || $[9] !== schema || $[10] !== searchFilter || $[11] !== searchQuery || $[12] !== searchStrategy || $[13] !== t3 || $[14] !== t4 || $[15] !== telemetry || $[16] !== typeNameFromFilter) {
    ...
    const partialList$ = listenSearchQuery(listenSearchQueryArgs).pipe(measureFirstMatch(_temp3$3, t62), shareReplay({
      refCount: true,
      bufferSize: 1
    })), fullList$ = onFetchFullList$.pipe(withLatestFrom(partialList$), filter(_temp4$3), take(1), mergeMap(() => concat(of({
      type: "loadFullList"
    }), listenSearchQuery({
    ...
    }, $[21] = onRetry$, $[22] = t7) : t7 = $[22], t5 = merge(partialList$.pipe(map(_temp6$2), takeUntil(fullList$)), fullList$).pipe(catchWithCount(t7), scan(_temp7$1, INITIAL_QUERY_STATE)), $[3] = client, $[4] = maxFieldDepth, $[5] = onFetchFullList$, $[6] = onRetry$, $[7] = paramsProp, $[8] = perspective, $[9] = schema, $[10] = searchFilter, $[11] = searchQuery, $[12] = searchStrategy, $[13] = t3, $[14] = t4, $[15] = telemetry, $[16] = typeNameFromFilter, $[17] = t5;
  } else
    t5 = $[17];
...
function _temp4$3(t0) {
  const [, result] = t0;
  return (result == null ? void 0 : result.documents.length) === PARTIAL_PAGE_LIMIT;
}
...
var DocumentListPane = (0, import_react2.memo)(function(props) {
  ...
  const typeName = t0, showIcons = (displayOptions == null ? void 0 : displayOptions.showIcons) !== false, {
    t: t2
  } = useTranslation(structureLocaleNamespace), {
    title
  } = useI18nText(pane), [searchQuery, setSearchQuery] = (0, import_react2.useState)(""), [searchInputValue, setSearchInputValue] = (0, import_react2.useState)(""), [searchInputElement, setSearchInputElement] = (0, import_react2.useState)(null);
  let t1;
  ...
  let t4;
  $[9] !== searchQuery ? (t4 = searchQuery == null ? void 0 : searchQuery.trim(), $[9] = searchQuery, $[10] = t4) : t4 = $[10];
  let t5;
  ...
  let t6;
  $[18] === Symbol.for("react.memo_cache_sentinel") ? (t6 = (event$) => event$.pipe(map(_temp$7), tap(setSearchInputValue), debounce(_temp2$4), tap(setSearchQuery)), $[18] = t6) : t6 = $[18];
...
var addIdsToMenuItems = (menuItems) => menuItems == null ? void 0 : menuItems.map((item) => item.id ? item : {
  ...item,
  id: assignId(item)
});
var addSelectedStateToMenuItems = (options) => {
  ...
  return menuItems == null ? void 0 : menuItems.map((item) => {
    ...
    if ((_c = item == null ? void 0 : item.params) == null ? void 0 : _c.by) {
      ...
      return {
        ...item,
        selected: isEqual_default(sortOrderRaw == null ? void 0 : sortOrderRaw.by, ((_d = item == null ? void 0 : item.params) == null ? void 0 : _d.by) || EMPTY_ARRAY$y),
        ...isInvalidSortOrder && {
          disabled: {
    ...
    if (item.id && item.id in customMenuItemState) {
      const storedValue = customMenuItemState[item.id], itemValue = ((_e = item.params) == null ? void 0 : _e.value) ?? true;
      return {
        ...item,
...
var PaneContainer = (0, import_react2.memo)(function(props) {
  const $ = (0, import_compiler_runtime2.c)(52), {
    ...
    menuItems,
    options
  } = pane, defaultLayout = t0 === void 0 ? "default" : t0, initialValueTemplates = t1 === void 0 ? EMPTY_ARRAY$y : t1, {
    defaultOrdering: t2,
    filter: filter2
  } = options, defaultOrdering = t2 === void 0 ? EMPTY_ARRAY$y : t2, params = useShallowUnique(options.params || EMPTY_RECORD), sourceName = pane.source;
  let t3;
  bb0: {
    let t42;
  ...
  let t4;
  $[3] !== defaultOrdering ? (t4 = (defaultOrdering == null ? void 0 : defaultOrdering.length) > 0 ? {
    by: defaultOrdering
  ...
  bb1: {
    ...
    let t72;
    $[8] !== defaultSortOrder || $[9] !== schemaType || $[10] !== sortOrderRaw ? (t72 = validateSortOrder(sortOrderRaw, schemaType, defaultSortOrder), $[8] = defaultSortOrder, $[9] = schemaType, $[10] = sortOrderRaw, $[11] = t72) : t72 = $[11], t62 = t72;
  }
  const validatedSortOrder = t62;
  let t7;
  ...
  let t8;
  $[16] === Symbol.for("react.memo_cache_sentinel") ? (t8 = {}, $[16] = t8) : t8 = $[16];
  const [customMenuItemState, setCustomMenuItemState] = (0, import_react2.useState)(t8);
  let t9;
  $[17] !== menuItems ? (t9 = addIdsToMenuItems(menuItems), $[17] = menuItems, $[18] = t9) : t9 = $[18];
  const menuItemsWithIds = t9;
  let t10;
  $[19] !== t6 ? (t10 = t6("panes.document-list-pane.sort-order.disabled-reason"), $[19] = t6, $[20] = t10) : t10 = $[20];
  ...
  let t14;
  $[30] !== customMenuItemState || $[31] !== handleSetSortOrder || $[32] !== index || $[33] !== initialValueTemplates || $[34] !== menuItemGroups || $[35] !== menuItemsWithSelectedState || $[36] !== setLayout || $[37] !== title ? (t14 = (0, import_jsx_runtime2.jsx)(PaneHeader, { customMenuItemState, index, initialValueTemplates, menuItemGroups, menuItems: menuItemsWithSelectedState, setLayout, setSortOrder: handleSetSortOrder, setCustomMenuItemState, title }), $[30] = customMenuItemState, $[31] = handleSetSortOrder, $[32] = index, $[33] = initialValueTemplates, $[34] = menuItemGroups, $[35] = menuItemsWithSelectedState, $[36] = setLayout, $[37] = title, $[38] = t14) : t14 = $[38];
  let t15;
  $[39] !== layout || $[40] !== props || $[41] !== validatedSortOrder ? (t15 = (0, import_jsx_runtime2.jsx)(DocumentListPane, { ...props, sortOrder: validatedSortOrder, layout }), $[39] = layout, $[40] = props, $[41] = validatedSortOrder, $[42] = t15) : t15 = $[42];
  let t16;
  $[43] !== isSelected || $[44] !== paneKey || $[45] !== t13 || $[46] !== t14 || $[47] !== t15 ? (t16 = (0, import_jsx_runtime2.jsxs)(Pane, { "data-ui": "DocumentListPane", id: paneKey, minWidth: 320, currentMaxWidth: 350, maxWidth: 640, selected: isSelected, children: [
    t13,
    t14,
    t15
  ] }), $[43] = isSelected, $[44] = paneKey, $[45] = t13, $[46] = t14, $[47] = t15, $[48] = t16) : t16 = $[48];
  let t17;
  return $[49] !== t12 || $[50] !== t16 ? (t17 = (0, import_jsx_runtime2.jsx)(SourceProvider, { name: t12, children: t16 }), $[49] = t12, $[50] = t16, $[51] = t17) : t17 = $[51], t17;
});
...
function getIntentState(intent, params, routerState, payload) {
  ...
  for (let i = activePanes.length - 1; i >= 0; i--) {
    ...
    if (typeof pane == "object" && (((_a = pane.canHandleIntent) == null ? void 0 : _a.call(pane, intent, params, {
      pane,
      index: i
...
function PublishedEventMenu(t0) {
  ...
  const handleOpenDraftDocument = t3, releaseTitle = (_b = (_a = event.release) == null ? void 0 : _a.metadata) == null ? void 0 : _b.title;
  let t4;
  ...
  $[20] !== event.release || $[21] !== isMenuDisabled || $[22] !== t2 ? (t9 = isMenuDisabled ? t2("timeline-item.not-found-release.tooltip", {
    releaseId: ((_c = event.release) == null ? void 0 : _c._id) ? getReleaseIdFromReleaseDocumentId(event.release._id) : void 0
  ...
  const t13 = ((_d = portalContext.elements) == null ? void 0 : _d[TIMELINE_MENU_PORTAL$1]) ? TIMELINE_MENU_PORTAL$1 : true;
  let t14;
  $[39] === Symbol.for("react.memo_cache_sentinel") ? (t14 = ["bottom-end", "bottom-start"], $[39] = t14) : t14 = $[39];
  let t15;
  $[40] !== t13 ? (t15 = {
    portal: t13,
    placement: "bottom",
...
var Root = yt(Popover2).withConfig({
  displayName: "Root",
...
function EventsTimelineMenu(t0) {
  ...
  bb0: {
    ...
    const t92 = !!nextCursor, t102 = event == null ? void 0 : event.id, t112 = mode === "rev" ? selectRev : selectSince;
    let t122;
...
var Scroller$2 = yt(ScrollContainer).withConfig({
  displayName: "Scroller",
  componentId: "sc-qjtu5v-0"
})`height:100%;overflow:auto;position:relative;scroll-behavior:smooth;`;
var Grid = yt(Box).withConfig({
  displayName: "Grid",
  componentId: "sc-qjtu5v-1"
})`&:not([hidden]){display:grid;}grid-template-columns:48px 1fr;align-items:center;gap:0.25em;`;
var SpinnerContainer = yt(Flex).withConfig({
...
var CompareWithPublishedView = () => {
  ...
  let t0;
  $[0] !== displayed || $[1] !== (editState == null ? void 0 : editState.published) ? (t0 = diffInput(wrap((editState == null ? void 0 : editState.published) ?? {}, {
    author: ""
  }), wrap(displayed ?? {}, {
    author: ""
  })), $[0] = displayed, $[1] = editState == null ? void 0 : editState.published, $[2] = t0) : t0 = $[2];
  const rootDiff = t0;
  ...
  let t3;
  $[7] !== selectedPerspective ? (t3 = isReleaseDocument(selectedPerspective) ? (_a = selectedPerspective.metadata) == null ? void 0 : _a.title : "draft", $[7] = selectedPerspective, $[8] = t3) : t3 = $[8];
  let t4;
  $[9] !== t3 ? (t4 = {
    version: t3
  }, $[9] = t3, $[10] = t4) : t4 = $[10];
...
function EventsInspector(t0) {
  const $ = (0, import_compiler_runtime2.c)(83), {
    ...
    sinceRevision,
    getChangesList
  } = useEvents(), isComparingCurrent = !(revision == null ? void 0 : revision.revisionId);
  let t1;
  ...
  let t22;
  $[2] !== diff || $[3] !== documentId || $[4] !== (formState == null ? void 0 : formState.readOnly) || $[5] !== isComparingCurrent || $[6] !== schemaType || $[7] !== value ? (t22 = () => ({
    documentId,
    schemaType,
    ...
    value,
    showFromValue: true
  }), $[2] = diff, $[3] = documentId, $[4] = formState == null ? void 0 : formState.readOnly, $[5] = isComparingCurrent, $[6] = schemaType, $[7] = value, $[8] = t22) : t22 = $[8];
  let t3;
  ...
  bb0: {
    ...
    let t52;
    $[12] !== events || $[13] !== (sinceRevision == null ? void 0 : sinceRevision.revisionId) ? (t52 = events.find((e2) => e2.id === (sinceRevision == null ? void 0 : sinceRevision.revisionId)) || null, $[12] = events, $[13] = sinceRevision == null ? void 0 : sinceRevision.revisionId, $[14] = t52) : t52 = $[14];
    let t62;
    $[15] !== events || $[16] !== (revision == null ? void 0 : revision.revisionId) ? (t62 = events.find((e_0) => e_0.id === (revision == null ? void 0 : revision.revisionId)) || events[0], $[15] = events, $[16] = revision == null ? void 0 : revision.revisionId, $[17] = t62) : t62 = $[17];
    let t72;
  ...
  let t18;
  $[65] !== diffError || $[66] !== documentContext || $[67] !== (revision == null ? void 0 : revision.loading) || $[68] !== schemaType || $[69] !== showChanges || $[70] !== sinceEvent || $[71] !== (sinceRevision == null ? void 0 : sinceRevision.loading) || $[72] !== timelineError || $[73] !== (toEvent == null ? void 0 : toEvent.id) ? (t18 = showChanges && (0, import_jsx_runtime2.jsx)(Content, { documentContext, error: timelineError || diffError, loading: (revision == null ? void 0 : revision.loading) || (sinceRevision == null ? void 0 : sinceRevision.loading) || false, schemaType, sameRevisionSelected: (sinceEvent == null ? void 0 : sinceEvent.id) === (toEvent == null ? void 0 : toEvent.id), sinceEvent }), $[65] = diffError, $[66] = documentContext, $[67] = revision == null ? void 0 : revision.loading, $[68] = schemaType, $[69] = showChanges, $[70] = sinceEvent, $[71] = sinceRevision == null ? void 0 : sinceRevision.loading, $[72] = timelineError, $[73] = toEvent == null ? void 0 : toEvent.id, $[74] = t18) : t18 = $[74];
  let t19;
...
var Scroller$1 = yt(ScrollContainer).withConfig({
  displayName: "Scroller",
...
function EventsSelector(t0) {
  ...
  let t3;
  return $[7] !== error || $[8] !== events || $[9] !== expandEvent || $[10] !== getScrollerRef || $[11] !== initialLoad || $[12] !== listHeight || $[13] !== loadMoreEvents || $[14] !== loading || $[15] !== nextCursor || $[16] !== (revision == null ? void 0 : revision.revisionId) || $[17] !== scrollRef || $[18] !== selectRev || $[19] !== showList ? (t3 = (0, import_jsx_runtime2.jsx)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: (0, import_jsx_runtime2.jsx)(Card, { flex: 1, padding: 2, paddingTop: 0, children: error ? (0, import_jsx_runtime2.jsx)(TimelineError, {}) : (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: scrollRef, children: (0, import_jsx_runtime2.jsxs)(Scroller$1, { "data-ui": "Scroller", ref: getScrollerRef, children: [
    listHeight && showList && !initialLoad ? (0, import_jsx_runtime2.jsx)(EventsTimeline, { events, fetchEventChildren: expandEvent, hasMoreEvents: !!nextCursor, selectedEventId: (revision == null ? void 0 : revision.revisionId) || ((_a = events[0]) == null ? void 0 : _a.id), onLoadMore: loadMoreEvents, onSelect: selectRev, listMaxHeight: `${listHeight}px` }) : null,
    loading && (0, import_jsx_runtime2.jsx)(LoadingBlock, {})
  ] }) }) }) }), $[7] = error, $[8] = events, $[9] = expandEvent, $[10] = getScrollerRef, $[11] = initialLoad, $[12] = listHeight, $[13] = loadMoreEvents, $[14] = loading, $[15] = nextCursor, $[16] = revision == null ? void 0 : revision.revisionId, $[17] = scrollRef, $[18] = selectRev, $[19] = showList, $[20] = t3) : t3 = $[20], t3;
}
var Scroller = yt(ScrollContainer).withConfig({
  displayName: "Scroller",
...
var FadeInFlex$1 = yt(Flex).withConfig({
...
function ChangesTabs(props) {
  ...
  const $ = (0, import_compiler_runtime2.c)(73), {
    ...
    t: tCore
  } = useTranslation(), isReady = (params == null ? void 0 : params.inspect) === HISTORY_INSPECTOR_NAME, {
    selectedPerspective
  } = usePerspective();
  let t0;
  ...
  let t19;
  $[39] === Symbol.for("react.memo_cache_sentinel") ? (t19 = (0, import_jsx_runtime2.jsx)(Text, { size: 0, muted: true, children: (0, import_jsx_runtime2.jsx)(InfoOutlineIcon, { fontSize: 1 }) }), $[39] = t19) : t19 = $[39];
  let t20;
  ...
  let t26;
  $[55] !== paneRouterTab || $[56] !== ((_b = (_a = source.beta) == null ? void 0 : _a.eventsAPI) == null ? void 0 : _b.documents) ? (t26 = ((_d = (_c = source.beta) == null ? void 0 : _c.eventsAPI) == null ? void 0 : _d.documents) ? (0, import_jsx_runtime2.jsx)(EventsSelector, { showList: paneRouterTab === "history" }) : (0, import_jsx_runtime2.jsx)(HistorySelector, { showList: paneRouterTab === "history" }), $[55] = paneRouterTab, $[56] = (_f = (_e = source.beta) == null ? void 0 : _e.eventsAPI) == null ? void 0 : _f.documents, $[57] = t26) : t26 = $[57];
  let t27;
  ...
  let t29;
  $[61] !== paneRouterTab || $[62] !== ((_h = (_g = source.beta) == null ? void 0 : _g.eventsAPI) == null ? void 0 : _h.documents) ? (t29 = ((_j = (_i = source.beta) == null ? void 0 : _i.eventsAPI) == null ? void 0 : _j.documents) ? (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: paneRouterTab === "review" ? (0, import_jsx_runtime2.jsx)(EventsInspector, { showChanges: paneRouterTab === "review" }) : null }) : (0, import_jsx_runtime2.jsx)(ChangesInspector, { showChanges: paneRouterTab === "review" }), $[61] = paneRouterTab, $[62] = (_l = (_k = source.beta) == null ? void 0 : _k.eventsAPI) == null ? void 0 : _l.documents, $[63] = t29) : t29 = $[63];
  let t30;
...
var IncomingReferenceDocument = (props) => {
  ...
  const referencePaths = t0, id = document2._id, schema = useSchema(), {
    ...
    routerPanesState,
    groupIndex
  } = usePaneRouter(), type = document2 == null ? void 0 : document2._type;
  let t1;
  ...
  let t3, t4;
  $[18] === Symbol.for("react.memo_cache_sentinel") ? (t3 = {
    opacity: 0
  }, t4 = {
    opacity: 1
...
function TypeSection(t0) {
  ...
  const title = (t1 == null ? void 0 : t1.title) || type;
  let t22;
...
function IncomingReferencesList() {
  ...
  const renderSameDatasetItem = t22, renderCrossDatasetItem = _temp7;
  let t3;
  $[10] !== t2 ? (t3 = t2("incoming-references-pane.no-references-found"), $[10] = t2, $[11] = t3) : t3 = $[11];
  const emptyMessage = t3, showEmptyState = !(references == null ? void 0 : references.loading) && (references == null ? void 0 : references.list.length) === 0 && !(crossDatasetRefs == null ? void 0 : crossDatasetRefs.loading) && (crossDatasetRefs == null ? void 0 : crossDatasetRefs.list.length) === 0;
  let t4;
  $[12] !== showEmptyState || $[13] !== t2 ? (t4 = showEmptyState && (0, import_jsx_runtime2.jsx)(Card, { border: true, radius: 3, padding: 1, tone: "default", children: (0, import_jsx_runtime2.jsx)(Box, { paddingY: 3, paddingX: 2, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, muted: true, children: t2("incoming-references-pane.no-references") }) }) }), $[12] = showEmptyState, $[13] = t2, $[14] = t4) : t4 = $[14];
  let t5;
  $[15] !== emptyMessage || $[16] !== (references == null ? void 0 : references.list) || $[17] !== (references == null ? void 0 : references.loading) || $[18] !== renderSameDatasetItem || $[19] !== t2 ? (t5 = (references == null ? void 0 : references.loading) ? (0, import_jsx_runtime2.jsx)(LoadingBlock, { showText: true, title: t2("incoming-references-input.types-loading") }) : references == null ? void 0 : references.list.map((t62) => {
    const {
      type: type_3,
  ...
  }), $[15] = emptyMessage, $[16] = references == null ? void 0 : references.list, $[17] = references == null ? void 0 : references.loading, $[18] = renderSameDatasetItem, $[19] = t2, $[20] = t5) : t5 = $[20];
  let t6;
  $[21] !== (crossDatasetRefs == null ? void 0 : crossDatasetRefs.list) || $[22] !== (crossDatasetRefs == null ? void 0 : crossDatasetRefs.loading) || $[23] !== emptyMessage || $[24] !== t2 ? (t6 = (crossDatasetRefs == null ? void 0 : crossDatasetRefs.loading) ? (0, import_jsx_runtime2.jsx)(LoadingBlock, { showText: true, title: t2("incoming-references-input.types-loading-cross-dataset") }) : crossDatasetRefs == null ? void 0 : crossDatasetRefs.list.map((t72) => {
    const {
      type: type_4,
  ...
  }), $[21] = crossDatasetRefs == null ? void 0 : crossDatasetRefs.list, $[22] = crossDatasetRefs == null ? void 0 : crossDatasetRefs.loading, $[23] = emptyMessage, $[24] = t2, $[25] = t6) : t6 = $[25];
  let t7;
  return $[26] !== t4 || $[27] !== t5 || $[28] !== t6 ? (t7 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    t4,
    t5,
    t6
...
var IncomingReferencesInspector = (props) => {
  ...
  let t4;
  $[8] === Symbol.for("react.memo_cache_sentinel") ? (t4 = (0, import_jsx_runtime2.jsx)(Card, { flex: 1, overflow: "auto", padding: 3, children: (0, import_jsx_runtime2.jsx)(IncomingReferencesList, {}) }), $[8] = t4) : t4 = $[8];
  let t5;
...
function getPathTitles(options) {
  ...
  for (const segment of path) {
    ...
    if (isRecord$4(segment) && segment._key) {
      ...
      let ofType = s2.of.find((i) => isRecord$4(v) && i.name === (v == null ? void 0 : v._type));
      if (!ofType && !(v == null ? void 0 : v._type)) {
...
function ValidationCard(props) {
  ...
  const handleClick = t0, [errorInfo, setErrorInfo] = (0, import_react2.useState)(null), Icon = MARKER_ICON[marker.level];
  let t1;
  ...
  let t2;
  $[5] !== Icon || $[6] !== errorInfo || $[7] !== handleClick || $[8] !== marker.level || $[9] !== marker.message || $[10] !== marker.path || $[11] !== schemaType || $[12] !== value ? (t2 = !errorInfo && (0, import_jsx_runtime2.jsx)(Card, { __unstable_focusRing: true, as: "button", onClick: handleClick, padding: 3, radius: 2, style: {
    userSelect: "text"
  }, tone: MARKER_TONE[marker.level], children: (0, import_jsx_runtime2.jsxs)(Flex, { align: "flex-start", gap: 3, children: [
...
function DocumentNodePathBreadcrumbs(props) {
  ...
  const pathTitles = t0;
  if (!(pathTitles == null ? void 0 : pathTitles.length))
    return null;
  let t1;
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index4-EUU7ZPW4.js")),
...
//# sourceMappingURL=chunk-LDHT5BF2.js.map
